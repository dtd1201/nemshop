...
class ParagraphCategoryPost extends Model
{
    //
    protected $table = "paragraph_category_posts";
    protected $guarded = [];
    ...
    public function translationsLanguage($language = null)
    {
        ...
        return $this->hasMany(ParagraphCategoryPostTranslation::class, "paragraph_id", "id")->where('language', '=', $language);
    }

    public function translations()
    {
        return $this->hasMany(ParagraphCategoryPostTranslation::class, "paragraph_id", "id");
    }
    ...
    {
        return $this->hasMany(ParagraphCategoryPost::class, 'parent_id', 'id');
    }

    public function parent()
    {
        return $this->belongsTo(ParagraphCategoryPost::class, 'parent_id', 'id');
    }
    ...
    {
        return $this
            ->belongsTo(CategoryPost::class,  'category_id', 'id');
    }
}
