...
class Setting extends Model
{
    ...
    protected $appends = ['breadcrumb','name', 'slug', 'value', 'content1', 'content2', 'content3', 'description', 'language'];
    ...
    // tạo thêm thuộc tính content1
    public function getContent1Attribute()
    {
        return optional($this->translationsLanguage()->first())->content1;
    }
    // tạo thêm thuộc tính content2
    public function getContent2Attribute()
    {
        return optional($this->translationsLanguage()->first())->content2;
    }
    // tạo thêm thuộc tính content3
