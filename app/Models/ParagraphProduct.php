...
class ParagraphProduct extends Model
{
    //

    protected $table = "paragraph_products";
    protected $guarded = [];
    ...
    public function translationsLanguage($language = null)
    {
        ...
        return $this->hasMany(ParagraphProductTranslation::class, "paragraph_id", "id")->where('language', '=', $language);
    }

    public function translations()
    {
        return $this->hasMany(ParagraphProductTranslation::class, "paragraph_id", "id");
    }
    ...
    {
        return $this->hasMany(ParagraphProduct::class, 'parent_id', 'id');
    }

    public function parent()
    {
        return $this->belongsTo(ParagraphProduct::class, 'parent_id', 'id');
    }
