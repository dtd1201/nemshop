...
class Post extends Model
{
    ...
    // tạo thêm thuộc tính time
    public function getTimeAttribute()
    {
        return optional($this->translationsLanguage()->first())->time;
    }
    // tạo thêm thuộc tính dia_diem
    public function getDiadiemAttribute()
    {
        return optional($this->translationsLanguage()->first())->dia_diem;
    }
    // tạo thêm thuộc tính range
    public function getRangeAttribute()
    {
        return optional($this->translationsLanguage()->first())->range;
    }
