...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'username', 'parent_id', 'parent_id2','parent_id3', 'giamdoc_id', 'giamdoc_id2', 'order', 'password', 'active', 'phone', 'date_birth', 'address', 'hktt', 'cmt', 'stk', 'ctk', 'bank_id', 'bank_branch', 'sex', 'status', 'avatar_path', 'code', 'admin_id','created_at','level','date_reset','loop', 'chuc_danh', 'nhanh', 'user_duoc_chon', 'type', 'point_sale', 'city_id', 'district_id', 'commune_id', 'image_cmt_before', 'image_cmt_after', 'kic'
    ];
    ...
    // lấy user cha được cộng tiền
    public function parent3()
    {
        return $this->belongsTo(User::class, 'parent_id3', 'id');
    }
