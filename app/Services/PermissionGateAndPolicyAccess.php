...
class PermissionGateAndPolicyAccess
{
    ...
    public function setGateAndPolicyAccess()
    {
        ...
        $this->defineGateKhoanChi();
        $this->defineGateAgency();
    ...
    public function defineGateKhoanChi()
    {
        // module khoanChi
        Gate::define('khoan-chi-list', 'App\Policies\Admins\AdminKhoanChiPolicy@list');
        Gate::define('khoan-chi-add', 'App\Policies\Admins\AdminKhoanChiPolicy@add');
        Gate::define('khoan-chi-edit', 'App\Policies\Admins\AdminKhoanChiPolicy@edit');
        Gate::define('khoan-chi-delete', 'App\Policies\Admins\AdminKhoanChiPolicy@delete');
        Gate::define('khoan-chi-active', 'App\Policies\Admins\AdminKhoanChiPolicy@active');
    }
    ...
    public function defineGateAgency()
    {
        // module supplier
        Gate::define('agency-list', 'App\Policies\Admins\AdminAgencyPolicy@list');
        Gate::define('agency-add', 'App\Policies\Admins\AdminAgencyPolicy@add');
        Gate::define('agency-edit', 'App\Policies\Admins\AdminAgencyPolicy@edit');
        Gate::define('agency-delete', 'App\Policies\Admins\AdminAgencyPolicy@delete');
    }
    public function defineGateReport()
    {
        // module report
        Gate::define('report-list', 'App\Policies\Admins\AdminReportPolicy@list');
    }
}
