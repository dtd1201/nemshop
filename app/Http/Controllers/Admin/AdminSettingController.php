    ...
    public function store(ValidateAddSetting $request)
    {
        try {
            ...
            foreach ($this->langConfig as $key => $value) {
                ...
                $itemSettingTranslation['content1'] = $request->input('content1_' . $key);
                $itemSettingTranslation['content2'] = $request->input('content2_' . $key);
                $itemSettingTranslation['content3'] = $request->input('content3_' . $key);
    ...
    public function update(ValidateEditSetting $request, $id)
    {
        try {
            ...
            foreach ($this->langConfig as $key => $value) {
                ...
                $itemSettingTranslationUpdate['content1'] = $request->input('content1_' . $key);
                $itemSettingTranslationUpdate['content2'] = $request->input('content2_' . $key);
                $itemSettingTranslationUpdate['content3'] = $request->input('content3_' . $key);
