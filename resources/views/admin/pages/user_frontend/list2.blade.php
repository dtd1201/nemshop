      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="{{route('admin.user_frontend.create2')}}" class="btn btn-info btn-md mb-2 float-left">+ Thêm mới</a>
                
                <form class="d-inline-block mb-2" action="{{route('admin.user_frontend.export.excel.database2')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    {{--
                   ...
                   <div class="card-tools w-100  p-1">
                    ...
                    <div class="card-header">
                        <div class="card-tools w-100 mb-3">
                            <form action="{{ route('admin.user_frontend.index2') }}" method="GET">
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="row">
                                    ...
                                    <div class="col-md-3 mb-0">
                                        ...
                                        <a  class="btn btn-danger w-40" href="{{ route('admin.user_frontend.index2') }}">Làm mới</a>
                                    </div>
                        ...
                        <table class="table table-head-fixed" style="font-size:13px;">
                            ...
                            <tbody>
                                @foreach($data as $item)
                                    @php
                                        $capdo = '';
                                        foreach($daiLy as $dly){
                                            if( $dly['value'] == $item->level ) {
                                                $capdo = $dly['name'];
                                            }
                                        }
                                    @endphp
                                ...
                                <tr>
                                    ...
                                    @if($item->type == 1)
                                    <td><span>{{ $capdo }}</span></td>
                                    @else
                                    <td><span>{{ $typeUser[$item->chuc_danh]['name'] }}</span></td>
                                    @endif
