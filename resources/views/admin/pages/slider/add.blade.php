                                ...
                                <div class="card-body table-responsive p-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check-inline">
                                            ...
                                            <input type="radio" class="form-check-input" value="1" name="type" @if(old('type')==='1' ||old('type')===null) {{'checked'}} @endif>Mobile
                                            </label>
                                        </div>
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" value="0" @if(old('type')==="0" ){{'checked'}} @endif name="type">Desktop
                                            </label>
                                        </div>
                                        @error('type')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
