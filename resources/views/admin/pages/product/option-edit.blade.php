                                        ...
                                        <div class="tab-content">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    @error('color') is-invalid @enderror" id="color" value="{{ old('color')??$data->color }}" name="color" placeholder="Nhập loại">
                                                                    @error('color')
                                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                                    @enderror
                                            ...
                                            <div id="hinh_anh" class="container tab-pane fade"><br>
                                                ...
                                                <div class="wrap-load-image mb-3">
                                                    ...
                                                    @enderror
                                                    @if ($data->avatar_type)
                                                    <img class="img-load border p-1 w-100" src="{{$data->avatar_type}}" alt="{{$data->color}}" style="height: 200px;object-fit:cover; max-width: 260px;">
                                                    @endif
                                                </div>
