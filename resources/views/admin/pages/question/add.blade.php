...
<div class="content-wrapper">
   @include('admin.partials.content-header',['name'=>"Câu hỏi","key"=>"Thêm câu hỏi"])
   <!-- Main content -->
   <div class="content">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            @error('name_'.$langItem['value']) is-invalid @enderror" id="name_{{$langItem['value']}}" value="{{ old('name_'.$langItem['value']) }}" name="name_{{$langItem['value']}}" placeholder="Nhập tiêu đề">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            @error('value_'.$langItem['value']) is-invalid  @enderror" id="slug_{{ $langItem['value'] }}" rows="5" name="value_{{ $langItem['value'] }}" placeholder="Nhập nôi dung">{{ old('slug_'.$langItem['value']) }}</textarea>
