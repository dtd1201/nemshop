...
@section('content')
  ...
  <div class="content-wrapper">
    @include('admin.partials.content-header',['name'=>"Câu hỏi","key"=>"Sửa câu hỏi"])
    <!-- Main content -->
    <div class="content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                @endif
                <form action="{{route('admin.question.update',['id'=>$data->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        @error('name_'.$langItem['value']) is-invalid @enderror" id="name_{{$langItem['value']}}" value="{{ old('name_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->name }}" name="name_{{$langItem['value']}}" placeholder="Nhập tiêu đề">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        @error('value_'.$langItem['value']) is-invalid  @enderror" id="value_{{ $langItem['value'] }}" rows="5" name="value_{{ $langItem['value'] }}" placeholder="Nhập nội dung">{{ old('value_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->value }}</textarea>
