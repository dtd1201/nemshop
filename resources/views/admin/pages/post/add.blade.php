                                                                ...
                                                                <div id="tong_quan_{{$langItem['value']}}" class="container wrapChangeSlug tab-pane {{$langItem['value']==$langDefault?'active show':''}} fade">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                <input type="text" class="form-control resultSlug changeAlias1
                                                                                @error('time_'.$langItem['value']) is-invalid  @enderror" id="time_{{ $langItem['value'] }}" value="{{ old('time_'.$langItem['value']) }}" name="time_{{ $langItem['value'] }}" placeholder="Nhập nội dung">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                <input type="text" class="form-control resultSlug changeAlias1
                                                                                @error('range_'.$langItem['value']) is-invalid  @enderror" id="range_{{ $langItem['value'] }}" value="{{ old('range_'.$langItem['value']) }}" name="range_{{ $langItem['value'] }}" placeholder="Nhập khoảng thu nhập">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                ...
                                                                                @error('dia_diem_'.$langItem['value']) is-invalid  @enderror" id="dia_diem_{{ $langItem['value'] }}" value="{{ old('dia_diem_'.$langItem['value']) }}" name="dia_diem_{{ $langItem['value'] }}" placeholder="Nhập địa điểm">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                <textarea class="form-control tinymce_editor_init  @error('value_'.$langItem['value']) is-invalid @enderror" name="value_{{$langItem['value']}}" id="" rows="15"  placeholder="Nhập mô tả">{{ old('value_'.$langItem['value']) }}</textarea>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                <textarea class="form-control tinymce_editor_init  @error('description_'.$langItem['value']) is-invalid @enderror" name="description_{{$langItem['value']}}" id="" rows="15"  placeholder="Nhập yêu cầu">{{ old('description_'.$langItem['value']) }}</textarea>
                                            ...
                                            <div class="card card-outline card-primary">
                                                ...
                                                {{--<div class="form-group">
                                                    ...
                                                    <div class="wrap-load-image mb-3">
                                                        ...
                                                        <img class="img-load border p-1 w-100" id="img_avatar_path" src="{{asset('admin_asset/images/upload-image.png')}}" style="height: 200px;object-fit:cover; max-width: 260px;">
                                                    </div>
