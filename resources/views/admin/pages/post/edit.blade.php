                                                    ...
                                                    <div id="tong_quan_{{$langItem['value']}}" class="container tab-pane {{$langItem['value']==$langDefault?'active show':''}} fade">
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    @error('name_'.$langItem['value']) is-invalid @enderror" id="nameChange" value="{{ old('name_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->name }}" name="name_{{$langItem['value']}}" placeholder="Nhập tên bài viết">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    @error('slug_'.$langItem['value']) is-invalid  @enderror" id="slug_{{ $langItem['value'] }}" value="{{ old('slug_'.$langItem['value'])??optional($data->key($langItem['value'])->first())->slug }}" name="slug_{{ $langItem['value'] }}" placeholder="Nhập slug">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    @error('time_'.$langItem['value']) is-invalid  @enderror" id="time_{{ $langItem['value'] }}" value="{{ old('time_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->time }}" name="time_{{ $langItem['value'] }}" placeholder="Nhập nội dung">
                                                                    @error('time_'.$langItem['value'])
                                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control  
                                                                    @error('dia_diem_'.$langItem['value']) is-invalid  @enderror" id="dia_diem_{{ $langItem['value'] }}" value="{{ old('dia_diem_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->dia_diem }}" name="dia_diem_{{ $langItem['value'] }}" placeholder="Nhập địa điểm">
                                                                    @error('dia_diem_'.$langItem['value'])
                                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control  
                                                                    @error('range_'.$langItem['value']) is-invalid  @enderror" id="range_{{ $langItem['value'] }}" value="{{ old('range_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->range }}" name="range_{{ $langItem['value'] }}" placeholder="Nhập khoảng thu nhập">
                                                                    @error('range_'.$langItem['value'])
                                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <textarea class="form-control tinymce_editor_init @error('value_'.$langItem['value']) is-invalid @enderror" name="value_{{$langItem['value']}}" id="" rows="3"  placeholder="Nhập mô tả">{{ old('value_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->value  }}</textarea>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <textarea class="form-control tinymce_editor_init @error('description_'.$langItem['value']) is-invalid @enderror" name="description_{{$langItem['value']}}" id="" rows="3"  placeholder="Nhập yêu cầu">{{ old('description_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->description  }}</textarea>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <textarea class="form-control tinymce_editor_init @error('content_'.$langItem['value']) is-invalid  @enderror" name="content_{{$langItem['value']}}" id="" rows="15" value="" placeholder="Nhập quyền lợi">
