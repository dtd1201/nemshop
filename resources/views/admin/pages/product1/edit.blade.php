                                            ...
                                            <div id="tong_quan" class="container tab-pane active"><br>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div id="tong_quan_{{$langItem['value']}}" class="container tab-pane {{$langItem['value']==$langDefault?'active show':''}} fade">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label class="col-sm-2 control-label" for="">Link 1</label>
                                                                <div class="col-sm-10">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label class="col-sm-2 control-label" for="">Link 2</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control changeAlias1
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label class="col-sm-2 control-label" for="">Link 3</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control changeAlias1
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label class="col-sm-2 control-label" for="">Link 4</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control changeAlias1
