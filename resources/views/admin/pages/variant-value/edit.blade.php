      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                @endif
                <form action="{{route('admin.variant-value.update',['id'=>$data->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                @error('value') is-invalid @enderror" id="value" value="{{ old('value')?? $data->value }}" name="value" placeholder="Nhập tên">
                                                @error('value')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="variant_id">
                                            @foreach($variants as $variant)
                                                <option  <?php if($data->variant_id==$variant->id){echo 'selected="selected"';} ?> value="{{$variant->id}}">{{$variant->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
