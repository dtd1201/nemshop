            ...
            <div class="d-flex">
                <div class="box-left lb_list_content_recusive ">
                    <div class="d-flex">
                        ...
                        <div class="col-sm-3 pt-2 pb-2 text-center wrap-load-hot" data-url="{{ route('admin.category-product.load.hot',['id'=>$value->id]) }}">
            ...
            @if ($value->childs->count())
                <ul class="font-weight-normal" style="display: none;">
                    @foreach ($value->childs as $childValue)
                        @include('admin.components.danh-muc-san-pham-child', ['childs' => $childValue])
                    @endforeach
                </ul>
            @endif
        </li>
