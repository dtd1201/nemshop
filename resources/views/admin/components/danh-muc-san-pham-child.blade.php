    ...
    <div class="d-flex flex-wrap ">
        <div class="box-left lb_list_content_recusive">
            <div class="d-flex">
                ...
                <div class="col-sm-3 pt-2 pb-2 text-center wrap-load-hot" data-url="{{ route('admin.category-product.load.hot',['id'=>$childValue->id]) }}">
    ...
    @if ($childValue->childs->count())
        <ul class="" style="display: none;">
            @foreach ($childValue->childs as $childValue2)
                @include('admin.components.danh-muc-san-pham-child', ['childValue' => $childValue2])
            @endforeach
        </ul>
    @endif
</li>
