                                    ...
                                    <div class="position-sticky">
                                        ...
                                        <div class="product_sharing">
                                            ...
                                            <div class="santhuongmai-new">
                                                ...
                                                <ul>
                                                    @if($data->link1 && count($data->link1)>0)
                                                    <li>
                                                        <a href="{{ $data->link1 }}">
                                                            <img src="https://nhathuocthanthien.com.vn/wp-content/uploads/2020/07/dgm_nttt_shopee.png" alt="">
                                                        </a>
                                                    </li>
                                                    @endif
                                                    @if($data->link2 && count($data->link2)>0)
                                                    <li>
                                                        <a href="{{ $data->link2 }}">
                                                            <img src="https://nhathuocthanthien.com.vn/wp-content/uploads/2020/07/dgm_nttt_shopee.png" alt="">
                                                        </a>
                                                    ...
                                                    @endif
                                                    @if($data->link3 && count($data->link3)>0)
                                                    <li>
                                                        <a href="{{ $data->link4 }}">
                                                            <img src="https://nhathuocthanthien.com.vn/wp-content/uploads/2020/07/dgm_nttt_shopee.png" alt="">
                                                        </a>
                                                    ...
                                                    @endif
                                                    @if($data->link4 && count($data->link4)>0)
                                                    <li>
                                                        <a href="{{ $data->link4 }}">
                                                            <img src="https://nhathuocthanthien.com.vn/wp-content/uploads/2020/07/dgm_nttt_shopee.png" alt="">
                                                        </a>
                                ...
                                <table class="table-detail">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @foreach($thuoc_tinh as $i)
                                            <td>{{$i->name}}</td>
                                            @endforeach
                                            @foreach($data->attributes()->where('active',1)->orderBy('order')->get() as $item)
                                            <td>{{$item->name}}</td>
                                            @endforeach
                                        </tr>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-sm-12 col-12">
                        ...
                        <div class="Evaluate">
                                ...
                                @foreach ($data->stars()->where('hot', 1)->where('parent_id', 0)->orderBy('created_at')->get() as $com)
                                <div class="itemcmt">
