...
<main>
              ...
              <div class="banner-wrapper">
                ...
                <div class="container">
                  <div class="banner-content">
                    ...
                    <a href="#{{ $tuyen_dung->slug }}" class="button">Xem các vị trí tuyển dụng</a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="home-about">
        <div class="container" id="{{ $about_us->slug }}">
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12">
              <div class="about-content">
                <h2 class="main-title">{{ $about_us->description }}</h2>
                <div class="desc">
                    {!! $about_us->content !!}
                </div>
              </div>
      ...
      <section id="home-advantage">
        <div class="container">
          <h2 class="main-title">{{ $NEM->name }}</h2>
          <div class="advantage-content">
            <div class="row">
                @foreach($NEM->childs as $item)
      ...
      <!-- START RECRUITMENT -->
        @if($tuyen_dung && $tuyen_dung->childs->count()>0)
        <section id="home-recruitment">
            <div class="container" id="{{ $tuyen_dung->slug }}">
                <div class="title-wrapper">
                    <h2 class="main-title">{{ $tuyen_dung->description }}</h2>
                    <div class="desc">
                    {!! $tuyen_dung->content !!}
                    </div>
                </div>
                @foreach($tuyen_dung->childs()->where('active', 1)->orderBy('order')->get() as $cate)
                <div class="recruitment-content-wrapper">
                    @if($cate->posts->count()>0)
                    <article class="recruitment-content-container">
                        <h3 class="sub-title">{{ $cate->name }}</h3>
                        <div class="recruitment-content-list">
                            <div class="row">
                                @foreach($cate->posts()->where('active', 1)->orderBy('order')->get() as $item)
                                <div class="col-lg-6 col-md-6 col-12">
