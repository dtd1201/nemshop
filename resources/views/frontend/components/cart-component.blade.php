            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control radius-8-mb  @error('nameCart')is-invalid   @enderror" 
...
<div class="col-lg-4 col-sm-12 col-12">
    <div class="cart-cta radius-12 radius-none">
        ...
        <div class="cart-cta__total">
            ...
            <div class="u-flex">
                <span class="txt-gray">Khuyến mãi giảm</span><span class="txt-gray">{{ number_format($cartItem['old_price'] - $cartItem['price']) }}đ</span>
            </div>
