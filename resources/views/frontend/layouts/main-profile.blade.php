                    ...
                    <div class="col-sm-3 bg-left">
                        <div id="sidebar-profile" class="pt-3 pb-3">
                            ...
                            <nav class="mt-2">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('profile.pointThuongPhat') }}">
                                        <i class="fas fa-cart-plus"></i>
                            ...
                            @if(($user->type == 2 && $user->chuc_danh == 4) || $user->type == 3 || $user->point_sale == 0)
                                
                            @else
                            
                            <div class="alert alert-success mt-4 hidden-scroll " style="overflow: auto;">
                                <input type="text" value="{{ route('profile.register-referral.create',['code'=>$user->code]) }}" id="myInput" style="background-color: transparent; border:unset;">
                            </div>
