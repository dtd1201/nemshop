...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-12">
                                <div class="card card-outline card-primary">
                                    <div class="card-header">
                                    <h3 class="card-title w-100">Đoạn văn đã thêm <a data-url="<?php echo e(route('admin.post.loadCreateParagraphPost',['id'=>$data->id])); ?>" class="btn  btn-info btn-md float-right " id="addParagraphAjax">+ Thêm đoạn văn</a></h3>
                                    </div>
                                    <div class="card-body table-responsive p-3">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/cus05.largevendor.com/httpdocs/resources/views/admin/pages/post/edit.blade.php ENDPATH**/ ?>