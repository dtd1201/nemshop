            ...
            <div class="d-flex">
                <div class="box-left lb_list_content_recusive ">
                    <div class="d-flex">
                        ...
                        <div class="col-sm-3 pt-2 pb-2 text-center wrap-load-hot" data-url="<?php echo e(route('admin.category-product.load.hot',['id'=>$value->id])); ?>">
            ...
            <?php if($value->childs->count()): ?>
                <ul class="font-weight-normal" style="display: none;">
                    <?php $__currentLoopData = $value->childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo $__env->make('admin.components.danh-muc-san-pham-child', ['childs' => $childValue], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /var/www/vhosts/demo5.tiemthietke.com/httpdocs/resources/views/admin/components/danh-muc-san-pham.blade.php ENDPATH**/ ?>