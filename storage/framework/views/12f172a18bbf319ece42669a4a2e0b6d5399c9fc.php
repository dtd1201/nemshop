                                                ...
                                                <ul>
                                                    <?php if(isset($about_us) && $about_us): ?>
                                                        <?php $__currentLoopData = $about_us->childs()->where('active', 1)->orderby('order')->limit(10)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li >
                                                                <h2>
                                                                    <a data-tab="listTab<?php echo e($post->id); ?>" class="scrollLink tab-li <?php if($loop->first): ?> active <?php endif; ?>"><i class="fa fa-doc"></i> <?php echo e($post->name); ?></a>
                                                                </h2>
                                                            </li>
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo.largevendor.com/httpdocs/resources/views/frontend/pages/about-us.blade.php ENDPATH**/ ?>