    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr class="cart-item">
                ...
                <td class="cart-name" data-title="<?php echo e(__('contact.product_name')); ?>:"><span><?php echo e($cartItem['name']); ?> <?php if(isset($cartItem['color']) && $cartItem['color']): ?> (<?php echo e($cartItem['color'] ?? ''); ?>) <?php endif; ?> <?php if(isset($cartItem['size']) && $cartItem['size']): ?> (<?php echo e($cartItem['size']); ?>) <?php endif; ?></span></td>
...
<?php /**PATH /var/www/vhosts/sieuthithoitrangcaocap.com/httpdocs/resources/views/frontend/components/cart-component.blade.php ENDPATH**/ ?>