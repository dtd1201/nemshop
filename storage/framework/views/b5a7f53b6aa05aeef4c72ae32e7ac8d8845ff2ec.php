    ...
    <div class="social-menu-mb">
        ...
        <div class="social-menu-main">
            <ul class="social">
                ...
                <li><a href="<?php echo e($item->slug); ?>"><img src="<?php echo e(asset($item->image_path)); ?>" alt="<?php echo e($item->name); ?>"></a></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
        </div>
		<h2><?php echo e($header['socialParent']->slug); ?></h2>
                    ...
                    <div class="h-cart dropdown show" id="li_desktop_cart">
                        ...
                        <div class="lc-tooltip-box notitfy-box" id="cartPopupDes">
                            ...
                            <div class="notitfy-checkout p-t-12">
                                <a href="<?php echo e(route('cart.list')); ?>" class="btn btn-md btn-primary txt-red" id="btnDoneOrder">
                                                                ...
                                                                <li class="nav-sub-item <?php if($loop->first): ?> active <?php endif; ?>" data-id="li_hangNoiDia<?php echo e($childValue->id); ?>">
                                                                    <a href="<?php echo e($childValue['slug_full']); ?>">
                                                                        <div class="sub-nav-picture m-r-8">
                                                                            <picture>
                                                                                <img alt="<?php echo e($childValue['name']); ?>" srcset="" class="loaded" src="<?php echo e($childValue['icon_path']?asset($childValue['icon_path']):asset('frontend/images/noimage.jpg')); ?>" />
                                                                            </picture>
                                                                        </div>
                                                                            ...
                                                                            <div class="col sub-nav-cate-item p-x-8">
                                                                                <a href="<?php echo e($childValueItem->slug_full); ?>" class="u-flex align-items-center bg-white txt-gray-800 circle p-y-4 p-l-4 p-r-16 box-full">
                                                                                    <div class="sub-nav-cate-picture m-r-8">
                                                                                        <picture>
                                                                                            <img alt="<?php echo e($childValueItem->name); ?>" srcset="" class="loaded" src="<?php echo e($childValueItem->icon_path?asset($childValueItem->icon_path):asset('frontend/images/noimage.jpg')); ?>" />
                                                                                        </picture>
                                                                                    </div>
                                                                                            ...
                                                                                            <div class="sub-nav-product-picture m-b-12">
                                                                                                <picture>
                                                                                                    <img
                                                                                                        ...
                                                                                                        class="loaded"
                                                                                                        src="<?php echo e($product->avatar_path?asset($product->avatar_path):asset('frontend/images/noimage.jpg')); ?>"
                                                                                                    />
                                                                                                </picture>
                                                                                            </div>
...
<?php /**PATH /var/www/vhosts/demo5.tiemthietke.com/httpdocs/resources/views/frontend/partials/header.blade.php ENDPATH**/ ?>