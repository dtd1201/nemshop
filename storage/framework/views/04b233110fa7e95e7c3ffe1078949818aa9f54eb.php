...
<li class=" lb_item_delete  border-bottom">
    <div class="d-flex flex-wrap ">
        ...
        <div class="pt-2 pb-2 lb_list_action_recusive" >
            <a href="<?php echo e(route('admin.categoryproduct.getEdit',['id'=>$childValue->id])); ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
            <a href="<?php echo e(route('admin.categoryproduct.getAdd',['parent_id'=>$childValue->id])); ?>" class="btn btn-sm btn-info">+ Thêm</a>
            <a data-url="<?php echo e(route('admin.categoryproduct.getDelete',['id'=>$childValue->id])); ?>" class="btn btn-sm btn-danger lb_delete_recusive"><i class="far fa-trash-alt"></i></a>
            <?php if($childValue->childs->count()): ?>
    ...
    <?php if($childValue->childs->count()): ?>
        <ul class="" style="display: none;">
            <?php $__currentLoopData = $childValue->childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childValue2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo $__env->make('admin.components.category-product-child', ['childValue' => $childValue2], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </ul>
    <?php endif; ?>
</li>

<?php /**PATH D:\xampp\htdocs\php-laravel\webbanhang\resources\views/admin/components/category-product-child.blade.php ENDPATH**/ ?>