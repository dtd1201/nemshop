							...
							<div class="row">
								<?php if(isset($categories)&&$categories): ?>
									<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										...
										?>
										<div class="col-lg-2 col-md-4 col-sm-6 col-6 background_sp">
                                    ...
                                    <?php if(isset($attributes) && $attributes): ?>
                                        <div class="lc__box-filter-desc">
                                            <ul class="filter-main">
                                                <?php $__currentLoopData = $attributes->childs()->where('active', 1)->orderBy('order')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attributeItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/cus05.largevendor.com/httpdocs/resources/views/frontend/pages/home.blade.php ENDPATH**/ ?>