...
unset($__errorArgs, $__bag); ?>" id="masp" value="<?php echo e(old('masp')); ?>" name="masp" placeholder="Nhập mã sản phẩm" required>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\web_tinh_toan\project_1\resources\views/admin/pages/product/add.blade.php ENDPATH**/ ?>