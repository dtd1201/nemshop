...
unset($__errorArgs, $__bag); ?>" id="content1_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('content1_'.$langItem['value'])); ?>" name="content1_<?php echo e($langItem['value']); ?>" placeholder="Nhập số điện thoại">
                                                                        <?php $__errorArgs = ['content1_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="content2_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('content2_'.$langItem['value'])); ?>" name="content2_<?php echo e($langItem['value']); ?>" placeholder="Nhập thời gian">
                                                                        <?php $__errorArgs = ['content2_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="content3_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('content3_'.$langItem['value'])); ?>" name="content3_<?php echo e($langItem['value']); ?>" placeholder="zalo">
                                                                        <?php $__errorArgs = ['content3_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="value_<?php echo e($langItem['value']); ?>" id="" rows="3"  placeholder="Nhập giới thiệu"><?php echo e(old('value_'.$langItem['value'])); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" name="description_<?php echo e($langItem['value']); ?>" id="" rows="20" value=""  placeholder="Nhập nội dung" >
                                                                        <?php echo e(old('description_'.$langItem['value'])); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo.largevendor.com/httpdocs/resources/views/admin/pages/setting/add.blade.php ENDPATH**/ ?>