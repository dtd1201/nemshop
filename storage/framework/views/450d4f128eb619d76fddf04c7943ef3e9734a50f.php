...
unset($__errorArgs, $__bag); ?>
                                     <img class="img-load border p-1 w-100" src="<?php echo e($data->image_path); ?>" alt="<?php echo e($data->name); ?>" style="height: 200px;object-fit:cover;">
                                </div>
                            </div>
                        </div>
                     </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\webbanhang\resources\views/admin/pages/slider/edit.blade.php ENDPATH**/ ?>