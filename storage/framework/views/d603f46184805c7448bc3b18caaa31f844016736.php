      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
              ...
              <?php endif; ?>
              <form class="form-horizontal" action="<?php echo e(route('admin.categoryproduct.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
unset($__errorArgs, $__bag); ?>" name="content" id="" rows="20" value="" placeholder="Nhập nội dung">
...
unset($__errorArgs, $__bag); ?>
                                                <img class="img-load p-1 w-100" src="<?php echo e(asset('admin_asset/images/upload-image.png')); ?>" alt="" style="height: 170px;object-fit:cover;max-width: 260px;">
                                            </div>
                                        </div>
                                        <!-- END Hình Ảnh -->
...
unset($__errorArgs, $__bag); ?>" id="" value="<?php echo e(old('title_seo')); ?>" name="title_seo" placeholder="Nhập title seo">
                                                    </div>
                                                </div>
...
unset($__errorArgs, $__bag); ?>" id="" value="<?php echo e(old('description_seo')); ?>" name="description_seo" placeholder="Nhập mô tả seo">
                                                    </div>
                                                </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/vision.vsscorp.vn/httpdocs/resources/views/admin/pages/categoryproduct/add.blade.php ENDPATH**/ ?>