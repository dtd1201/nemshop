...
<div class="content-wrapper">
   <?php echo $__env->make('admin.partials.content-header',['name'=>"Amin User","key"=>"Sửa tài khoản"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
   <!-- Main content -->
   <div class="content">
      <div class="container-fluid">
         <div class="row">
            <div class="col-md-12">
               ...
               <?php endif; ?>
               <form action="<?php echo e(route('admin.user.update',['id'=>$data->id])); ?>" method="POST">
                  <?php echo csrf_field(); ?>
                  <div class="row">
                     <div class="col-md-8">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <input
                                    ...
                                    class="form-control"
                                    id=""
                                    value="<?php echo e($data->email); ?>"  name="email"
                                    placeholder="Email"
                                    >
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <select name="role_id[]" class="form-control select-2-init" id="" multiple>
                                    ...
                                    <option
                                    <?php echo e($dataRolesOfUser->get()->contains($roleItem->id)?'selected':""); ?>

                                    value="<?php echo e($roleItem->id); ?>"
                                    >
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\web_tinh_toan\vision-2\mayphotophuson.vn\resources\views/admin/pages/user/edit.blade.php ENDPATH**/ ?>