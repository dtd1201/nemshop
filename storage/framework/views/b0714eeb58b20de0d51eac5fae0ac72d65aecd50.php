      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-5">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('admin.bank.update',['id'=>$data->id])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\web_tinh_toan\project_1\resources\views/admin/pages/bank/edit.blade.php ENDPATH**/ ?>