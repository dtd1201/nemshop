...
unset($__errorArgs, $__bag); ?>" id="model_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('model_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->model); ?>" name="model_<?php echo e($langItem['value']); ?>" placeholder="Nhập Thương hiệu">
                                                                    <?php $__errorArgs = ['model_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="tinhtrang_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('tinhtrang_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->tinhtrang); ?>" name="tinhtrang_<?php echo e($langItem['value']); ?>" placeholder="Nhập Trạng thái">
                                                                    <?php $__errorArgs = ['tinhtrang_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="baohanh_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('baohanh_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->baohanh); ?>" name="baohanh_<?php echo e($langItem['value']); ?>" placeholder="Khuyến mại đặc biệt">
                                                                    <?php $__errorArgs = ['baohanh_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="description_<?php echo e($langItem['value']); ?>" id="" rows="3"  placeholder="Nhập giới thiệu trái"><?php echo e(old('description_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->description); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" name="content4_<?php echo e($langItem['value']); ?>" id="" rows="3"  placeholder="Nhập giới thiệu phải"><?php echo e(old('content4_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->content4); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" name="content3_<?php echo e($langItem['value']); ?>" id="" rows="3" value="" placeholder="Nhập khuyến mại sản phẩm">
                                                                    <?php echo e(old('content3_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->content3); ?>
...
unset($__errorArgs, $__bag); ?>" name="content2_<?php echo e($langItem['value']); ?>" id="" rows="20" value="" placeholder="Nhập chính sách bảo hành">
                                                                    <?php echo e(old('content2_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->content2); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="card card-outline card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Các lựa chọn kích thước</h3>
                                    </div>
                                     <div class="card-body table-responsive p-3">
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('size')??$data->size); ?>" name="size" placeholder="Nhập kích thước">
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('sizeOptionOld')[$key]??$item->size); ?>" name="sizeOptionOld[]" placeholder="Nhập kích thước">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="">Thêm kích thước mới  <a data-url="<?php echo e(route('admin.product.loadOptionProduct')); ?>" class="btn  btn-info btn-md float-right " id="addOptionProduct">+ Thêm option</a></div>
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('sizeOption')[$key]); ?>" name="sizeOption[]" placeholder="Nhập kích thước">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/largevendor.com/demo4.largevendor.com/resources/views/admin/pages/product/edit.blade.php ENDPATH**/ ?>