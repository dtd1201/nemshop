                            ...
                            <div class="col-xs-12">
                                <div class="group-title">
                                    <div class="title text-left title-red d-flex align-items-center">
                                        <span>Liên hệ</span>
                                        <form action="<?php echo e(URL::to('/tim-kiem-dai-ly')); ?>" id="form1" name="form1" method="GET" role="form" class="form-search-icon">
                                            <div class="form-group">
                                                <label for="" class="search-label">
                                                <input type="text" name="keyword" class="form-control" id="gone22" placeholder="Tìm kiếm">
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/vision.vsscorp.vn/httpdocs/resources/views/frontend/pages/contact.blade.php ENDPATH**/ ?>