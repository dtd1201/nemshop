                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-12 col-xs-12 block-content-right">
                            ...
                            <?php if(isset($products) && $products->childs()->count() > 0): ?>
                                 <div class="list-category">
                                    
                                    <?php echo $__env->make('frontend.components.category-product',[
                                        'data'=> $products->childs()->where('active', 1)->orderby('order')->get() ?? null,
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/food.mauwebsite.asia/httpdocs/resources/views/frontend/pages/product-by-category.blade.php ENDPATH**/ ?>