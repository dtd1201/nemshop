...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label" for="">Sản phẩm khuyễn mại</label>
...
unset($__errorArgs, $__bag); ?>" value="1" name="sp_ngoc" <?php if(old('sp_ngoc')==="1"||$data->sp_ngoc==1 ): ?> <?php echo e('checked'); ?> <?php endif; ?>>
                                                </label>
                                            </div>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="checkbox" class="form-check-input <?php $__errorArgs = ['bo_suu_tap'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid
...
unset($__errorArgs, $__bag); ?>" value="1" name="bo_suu_tap" <?php if(old('bo_suu_tap')==="1"||$data->bo_suu_tap==1 ): ?> <?php echo e('checked'); ?> <?php endif; ?>>
                                                </label>
                                            </div>
                                            <?php $__errorArgs = ['bo_suu_tap'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                ...
                                                <div class="item-price">
                                                    <div class="box-content-price">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" name="idOption<?php echo e($key); ?>" value="<?php echo e($item->id); ?>">
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('priceOptionOld')[$key]??$item->price); ?>" name="priceOptionOld[]" placeholder="Nhập giá trước">
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <input type="hidden" value="<?php echo e(old('option_id')[$key]??$item->id); ?>">
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('old_priceOptionOld')[$key]??$item->price); ?>" name="old_priceOptionOld[]" placeholder="Nhập giá sau">
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label" for="">Chọn màu</label>
                                                            <input type="text"  class="form-control  <?php $__errorArgs = ['colorOptionOld.'.$key];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid  <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('colorOptionOld')[$key]??$item->color); ?>" name="colorOptionOld[]" placeholder="Nhập mã màu">
                                                            <?php $__errorArgs = ['colorOptionOld.'.$key];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" id="" name="avatar_typeOld[]">
                                                            <?php if($item->avatar_type): ?>
                                                            <img src="<?php echo e(asset($item->avatar_type)); ?>" alt="<?php echo e($item->name); ?>">
                                                            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e($value); ?>" name="priceOption[]" placeholder="Nhập giá trước">
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e($value); ?>" name="old_priceOption[]" placeholder="Nhập giá sau">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label" for="">Chọn size</label>
                                                                <input type="text" class="form-control  <?php $__errorArgs = ['sizeOption.'.$key];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid  <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('sizeOption')[$key]); ?>" name="sizeOption[]" placeholder="Nhập size">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label" for="">Chọn color</label>
                                                                <input type="text" class="form-control  <?php $__errorArgs = ['colorOption.'.$key];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid  <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('colorOption')[$key]); ?>" name="colorOption[]" placeholder="Nhập color">
                                                                <?php $__errorArgs = ['colorOption.'.$key];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('colorOption')[$key]); ?>" name="colorOption[]" placeholder="Nhập mã màu">
                                                                <?php $__errorArgs = ['colorOption.'.$key];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/sieuthithoitrangcaocap.com/httpdocs/resources/views/admin/pages/product/edit.blade.php ENDPATH**/ ?>