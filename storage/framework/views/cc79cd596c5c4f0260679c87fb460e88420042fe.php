...
<body>
    <div class="box_404">
        <div class="logo_bfc">
            <img src="<?php echo e(asset('/frontend/images/logo404.png')); ?>" alt="Logo">
        </div>
        <div class="img_404">
        ...
        <div class="menu_line">
            <a href="<?php echo e(URL::to('/')); ?>">Quay lại Trang Chủ</a>
        </div>
    </div>
</body>
</html>
<?php /**PATH D:\xampp\htdocs\php-laravel\web_tinh_toan\vision-2\mayphotophuson.vn\resources\views/errors/404.blade.php ENDPATH**/ ?>