                        ...
                        <table class="table table-head-fixed" style="font-size:13px;">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adminItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(\Auth::user()->id == 2 && $adminItem->is_default == 1): ?>
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if($adminItem->id == \Auth::user()->id): ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/food.mauwebsite.asia/httpdocs/resources/views/admin/pages/user/list.blade.php ENDPATH**/ ?>