                        ...
                        <table class="table table-head-fixed" style="font-size:13px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo e(asset('/upload/images/'.$postItem->avatar_path)); ?>" alt="<?php echo e($postItem->name); ?>" style="width:80px;"></td>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo15.dkcauto.net/httpdocs/resources/views/admin/pages/post/list.blade.php ENDPATH**/ ?>