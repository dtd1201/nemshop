                                            ...
                                            <div>
                                                <?php if(isset($about_us) && $about_us): ?>
                                                    ...
                                                    <div class="tab-content listTab<?php echo e($post->id); ?> <?php if($loop->first): ?> current <?php endif; ?>">
                                                        <div class="name-p"><?php echo e($post->name); ?> <span><?php echo e($post->name); ?></span></div>
                                                        <div class="content-p">
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/cus05.largevendor.com/httpdocs/resources/views/frontend/pages/about-us.blade.php ENDPATH**/ ?>