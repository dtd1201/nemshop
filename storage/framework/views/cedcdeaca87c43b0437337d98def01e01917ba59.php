        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php endif; ?>
                    <form class="form-horizontal" action="<?php echo e(route('admin.categorypost.update',['id'=>$data->id])); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-12">
...
unset($__errorArgs, $__bag); ?>" id="name_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('name_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->name); ?>" name="name_<?php echo e($langItem['value']); ?>" placeholder="Nhập tên danh mục">
                                                                    <?php $__errorArgs = ['name_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="" value="<?php echo e(old('parent_id')); ?>" name="parent_id">
                                                                ...
                                                                <?php echo \App\Models\CategoryPost::getHtmlOptionAddWithParent(old('parent_id')); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\web_tinh_toan\vision-2\backuptan\resources\views/admin/pages/categorypost/edit.blade.php ENDPATH**/ ?>