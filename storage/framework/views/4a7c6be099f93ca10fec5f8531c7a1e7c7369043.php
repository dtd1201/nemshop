...
unset($__errorArgs, $__bag); ?>" name="content4_<?php echo e($langItem['value']); ?>" id="" rows="20" value="" placeholder="Nhập chính sách bảo hành">
                                                                    <?php echo e(old('content4_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->content4); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/magnus-pro.com.vn/httpdocs/resources/views/admin/pages/product/edit.blade.php ENDPATH**/ ?>