<?php $__env->startSection('title', 'Thêm danh mục ' . $categoryConfig['type']); ?>
<?php $__env->startSection('content'); ?>


    <div class="content-wrapper">

        <?php echo $__env->make('admin.partials.content-header',['name'=>"Danh mục","key"=>"Thêm danh mục ".$categoryConfig['type']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php endif; ?>
                        <form class="form-horizontal" action="<?php echo e(route($categoryConfig['routeNameStore'])); ?>" method="POST"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control lb_load_slug"
                                                                    id="slug" value="<?php echo e(old('slug')); ?>" name="slug"
...
unset($__errorArgs, $__bag); ?>"
                                                                    ...
                                                                    placeholder="Nhập mô tả"><?php echo e(old('description')); ?></textarea>
                                                            </div>
                                                        </div>
...
unset($__errorArgs, $__bag); ?>"
                                                                    ...
                                                                    placeholder="Nhập nội dung"> <?php echo e(old('content')); ?></textarea>
                                                            </div>
                                                        </div>
...
unset($__errorArgs, $__bag); ?>"
                                                                    id="" value="<?php echo e(old('title_seo')); ?>" name="title_seo"
...
unset($__errorArgs, $__bag); ?>"
                                                                    id="" value="<?php echo e(old('description_seo')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                                    id="" value="<?php echo e(old('keyword_seo')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" value="<?php echo e(old('order')); ?>"
                                                ...
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" class="form-check-input" value="1"
                                                            name="active" <?php if(old('active') === '1' || old('active') === null): ?><?php echo e('checked'); ?>  <?php endif; ?>>
                                                        Hiện
                                                    </label>
                                                </div>
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" class="form-check-input" value="0"
                                                            <?php if(old('active') === '0'): ?> <?php echo e('checked'); ?>  <?php endif; ?> name="active">
                                                        Ẩn
                                                    </label>
                                                </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/food.mauwebsite.asia/httpdocs/resources/views/admin/pages/category/add.blade.php ENDPATH**/ ?>