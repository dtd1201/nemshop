                                  ...
                                  <form action="<?php echo e(route('admin.transaction.index')); ?>" method="GET">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 text-right">
                                            ...
                                            <a href="<?php echo e(route('admin.transaction.index')); ?>" class="btn btn-danger">Reset</a>
                                        </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\web_tinh_toan\project_1\resources\views/admin/pages/transaction/index.blade.php ENDPATH**/ ?>