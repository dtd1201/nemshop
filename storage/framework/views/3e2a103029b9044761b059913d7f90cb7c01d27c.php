        ...
        <li class="nav_item <?php if($listItemSlugFull->contains($urlActive)): ?> active <?php endif; ?>">
            ...
            <?php if($value->childs->count()): ?>
                <ul class="menu-side-bar-leve-2" <?php if($listItemSlugFull->contains($urlActive)): ?> style="display:block" <?php endif; ?>>
                    <?php $__currentLoopData = $value->childs()->orderby('order')->orderByDesc('created_at')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /var/www/vhosts/magnus-pro.com.vn/httpdocs/resources/views/frontend/components/category.blade.php ENDPATH**/ ?>