      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
              ...
              <?php endif; ?>
              <form action="<?php echo e(route('admin.categoryproduct.postAdd')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                  ...
                  <input
                    ...
                    data-url="<?php echo e(route('admin.ajax.loadstr',['modelName'=>'categoryproduct'])); ?>"
                    id=""
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\webbanhang\resources\views/admin/page/categoryproduct/add.blade.php ENDPATH**/ ?>