        ...
        <div class="box-left lb_list_content_recusive">
            <div class="d-flex">
                ...
                <div class="col-sm-3 pt-2 pb-2 parent text-center">
                    <a  class="btn btn-sm <?php echo e($childValue->hot==1?'btn-danger':'btn-info'); ?> lb-hot" style="width:63px;"><?php echo e($childValue->hot==1?'Nổi bật':'Không'); ?></a>
                </div>
...
<?php /**PATH /var/www/vhosts/sieuthithoitrangcaocap.com/httpdocs/resources/views/admin/components/category-child.blade.php ENDPATH**/ ?>