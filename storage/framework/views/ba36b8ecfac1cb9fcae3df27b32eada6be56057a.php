                           ...
                           <div class="card-body table-responsive p-0">
                              <table class="table table-head-fixed">
                                 ...
                                 <tbody>
                                     ...
                                     <tr>
                                        <td><input type="checkbox" class="checkbox" data-id="<?php echo e($transaction->id); ?>"></td>
                                         ...
                                         <td>
                                             <ul>
                                                <li>
                                                 ...
                                                 <li>
                                                <strong>Địa chỉ:</strong>    <?php echo e($transaction->address_detail); ?>, <?php echo e($transaction->district->name); ?>, <?php echo e($transaction->city->name); ?>

                                                </li>

                                                <?php if(!empty($transaction->eInvoiceType) && $transaction->eInvoiceType != null): ?>
                                                    <li>
                                                        <strong>Hóa đơn</strong>    <?php echo e($transaction->eInvoiceType == 1 ? 'Công ty' : 'Cá nhân'); ?>

                                                    </li>
                                                    <li>
                                                        <strong>Tên công ty</strong>    <?php echo e($transaction->companyName ?? ''); ?>

                                                    </li>
                                                    <li>
                                                        <strong>Mã số thuế</strong>    <?php echo e($transaction->companyTax ?? ''); ?>

                                                    </li>
                                                    <li>
                                                        <strong>Địa chỉ công ty</strong>    <?php echo e($transaction->companyAddress ?? ''); ?>

                                                    </li>
                                                <?php endif; ?>
                                                 <li>
                                                    <strong>Hình thức thanh toán:</strong>   <?php echo e($transaction->payment == 1 ? 'Thanh toán tiền mặt khi nhận hàng' : ''); ?>
        ...
        if(idsArr.length <=0)  {  
            alert("Vui lòng chọn ít nhất một bản ghi để xóa.");  
                ...
                if(confirm("Bạn có chắc chắn không, bạn muốn xóa các bản ghi đã chọn ?")){  
                    ...
                    $.ajax({
                    url: "<?php echo e(route('admin.transaction.multiple_transaction_delete')); ?>",
                    type: 'POST',
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/thuoctot365.vn/httpdocs/resources/views/admin/pages/transaction/index.blade.php ENDPATH**/ ?>