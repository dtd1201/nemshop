...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('size')??$data->size); ?>" name="size" placeholder="Nhập số kg">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('sizeOptionOld')[$key]??$item->size); ?>" name="sizeOptionOld[]" placeholder="Nhập số kg">
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('sizeOption')[$key]); ?>" name="sizeOption[]" placeholder="Nhập số kg">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/food.mauwebsite.asia/httpdocs/resources/views/admin/pages/product/edit.blade.php ENDPATH**/ ?>