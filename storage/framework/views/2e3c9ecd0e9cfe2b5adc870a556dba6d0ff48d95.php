    ...
    <div class="compare-card">
        <div class="box">
            <div class="image">
                ...
                <?php endif; ?>
                <a data-url="<?php echo e(route('compare.remove',['id'=>$product->id])); ?>" class="btn btn-danger remove-compare"><i class="fas fa-times-circle"></i></a>
            </div>
            <div class="content">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH /var/www/vhosts/magnus-pro.com.vn/httpdocs/resources/views/frontend/components/compare-component.blade.php ENDPATH**/ ?>