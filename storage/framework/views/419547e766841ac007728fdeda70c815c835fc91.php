                            ...
                            <div class="shadow padding-content">
                                ...
                                <div class="list-news-3">
                                    ...
                                    <div class="card-news-horizontal">
                                        <div class="box">
                                            <div class="image">
                                                <a href="<?php echo e(makeLink('tuyen-dung-detail',$post->id,$post->slug)); ?>"><img src="<?php echo e(asset($post->avatar_path)); ?>" alt="<?php echo e($post->name); ?>"></a>
                                            </div>
                                            <div class="content">
                                                <h3><a href="<?php echo e(makeLink('tuyen-dung-detail',$post->id,$post->slug)); ?>"><?php echo e($post->name); ?></a></h3>
                                                <div class="desc">
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12 block-content-right p-75" id="side-bar">
                            <div class="side-bar">
                                <div class="title-sider-bar">
                                    <span><?php echo e(__('tuyen-dung.tin_tuyen_dung_noi_bat')); ?></span>
                                </div>
                                ...
                                <div class="list-trending">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="box">
                                                <div class="icon">
                                                    <a href="<?php echo e(makeLink('tuyen-dung-detail',$item->id,$item->slug)); ?>"
                                                    >
                                                ...
                                                <div class="content">
                                                    <h3 class="name">
                                                        <a href="<?php echo e(makeLink('tuyen-dung-detail',$item->id,$item->slug)); ?>"><?php echo e($item->name); ?></a>
                                                    </h3>
                                                    <div class="desc">
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\web_tinh_toan\vision-2\backuptan\resources\views/frontend/pages/tuyendung.blade.php ENDPATH**/ ?>