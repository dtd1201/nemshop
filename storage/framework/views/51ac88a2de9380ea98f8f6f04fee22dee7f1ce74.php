  ...
  <ul class="menu-side-bar">
    ...
    ?>
        <li class="nav_item <?php if(isset($active)&&$active->contains($value->id)): ?> active <?php endif; ?>">
            ...
            <?php if($value->childs->count()): ?>
                <ul class="menu-side-bar-leve-2" <?php if(isset($active)&&$active->contains($value->id)): ?> style="display:block" <?php endif; ?>>
...
<?php /**PATH /var/www/vhosts/cus01.largevendor.com/httpdocs/resources/views/frontend/components/category-product.blade.php ENDPATH**/ ?>