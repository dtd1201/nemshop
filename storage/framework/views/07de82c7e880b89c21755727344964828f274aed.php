                                                        ...
                                                        <div class="box">
                                                            <div class="image">
                                                                <a href="<?php echo e(makeLink('post',$post_item->id, $slug_post)); ?>">
                                                                    <img src="<?php echo e($post_item->avatar_path != null ? asset('/upload/images/'.$post_item->avatar_path) : '../frontend/images/no-images.jpg'); ?>" alt="<?php echo e($post_item->name); ?>"></a>
                                                            </div>
                                                            <div class="content">
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo15.dkcauto.net/httpdocs/resources/views/frontend/pages/post-by-category.blade.php ENDPATH**/ ?>