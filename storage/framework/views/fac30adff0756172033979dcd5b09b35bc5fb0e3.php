...
unset($__errorArgs, $__bag); ?>" id="" value="<?php echo e(old('name')); ?>"  name="name" placeholder="Nhập tên sản phẩm">
...
unset($__errorArgs, $__bag); ?>" id="" value="<?php echo e(old('slug')); ?>" name="slug" placeholder="Nhập slug">
                  </div>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control tinymce_editor_init <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" name="description" id="" rows="3" value="" placeholder="Nhập description"><?php echo e(old('description')); ?></textarea>
                  </div>
...
unset($__errorArgs, $__bag); ?>" name="content" id="" rows="3" value="" placeholder="Nhập content"><?php echo e(old('content')); ?></textarea>
                  </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\php-laravel\webbanhang\resources\views/admin/page/product/add.blade.php ENDPATH**/ ?>