                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-12 col-sm-12 col-item-footer">
                                <div class="title-footer">
                                    <?php echo e(__('footer.map')); ?>

                                </div>
								<?php if(isset($footer['mapss']) && $footer['mapss']): ?>
								<div class="mapss">
...
<?php /**PATH /var/www/vhosts/cus01.largevendor.com/httpdocs/resources/views/frontend/partials/footer.blade.php ENDPATH**/ ?>