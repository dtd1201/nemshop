                        ...
                        <table class="table table-head-fixed" style="font-size: 13px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($productItem->masp); ?></td>
                                    <td><?php echo e($productItem->name); ?></td>

                                    <td class="text-nowrap"><strong><?php echo e(number_format($productItem->price)); ?></strong></td>
                                    
                                    <td><?php echo e($productItem->stores()->select(\App\Models\Store::raw('SUM(quantity) as total'))->first()->total? $productItem->stores()->select(\App\Models\Store::raw('SUM(quantity) as total'))->first()->total:0); ?></td>
                                    <td class="text-nowrap">
                                        
                                        <?php echo e($productItem->stores()->whereIn('type',[2,3])->select(\App\Models\Store::raw('SUM(quantity) as total'))->first()->total? $productItem->stores()->whereIn('type',[2,3])->select(\App\Models\Store::raw('SUM(quantity) as total'))->first()->total:0); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\web_tinh_toan\project_1\resources\views/admin/pages/product/list.blade.php ENDPATH**/ ?>