        ...
        <div class="box-left lb_list_content_recusive">
            <div class="d-flex">
                ...
                <div class="col-sm-3 pt-2 pb-2 parent text-center">
                    ...
                    <?php echo $childValue->active==1?"<i class='fas fa-check-circle'></i>":"<i class='fas fa-times-circle'></i>"; ?>
...
<?php /**PATH /var/www/vhosts/vision.vsscorp.vn/httpdocs/resources/views/admin/components/category-child.blade.php ENDPATH**/ ?>