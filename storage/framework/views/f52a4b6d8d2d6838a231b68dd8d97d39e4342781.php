                                    ...
                                    <div class="order-content">
                                        ...
                                        <div class="infor-order mb-3">
                                            ...
                                            <ul class="list-infor">
                                                ...
                                                <li><span>Giao đến </span> <?php echo e($data->address_detail); ?>, <?php echo e($data->commune->name); ?>, <?php echo e($data->district->name); ?>, <?php echo e($data->city->name); ?> (nhân viên sẽ gọi xác nhận trước khi giao).</li>
                                                <li class="total-price"><span>Tổng tiền </span> <?php echo e(number_format($data->total)); ?></li>
                                                <li class="total-price"><span>Tri trả bằng tiền </span> <?php echo e(number_format($data->money)); ?> <?php echo e($unit); ?></li>
                                                <li class="total-price"><span>Tri trả bằng điểm </span> <?php echo e(number_format($data->point)); ?> <?php echo e($pointUnit); ?></li>
                                            </ul>
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\web_tinh_toan\project_1\resources\views/frontend/pages/order-sucess.blade.php ENDPATH**/ ?>