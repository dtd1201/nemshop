                        ...
                        <div class="box-header-top">
                            <div class="box-social-header-top">
                                <div class="box-info d-none d-lg-block">
                                    <ul>
                                        <li class="phone"><?php echo e($header['title']->value); ?></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="box-social-header-top">
                                <div class="box-info hidden-xs hidden-sm">
                                    <ul>
                                        <li><a href="tel:<?php echo e($header['hotline']->value); ?>" class="phone"><i class="fas fa-phone-volume"></i> Hotline: <strong style="color: #ff0"><?php echo e($header["hotline"]->value); ?></strong></a></li>
                ...
                <div class="box-header-main">
                    ...
                    <div class="wrap-search-header-main  d-none d-xl-block">
                        <div class="box-search-header-main">
                            ...
                            <select name="category_id" form="formSearch" class="form-control">
                                <option value="0">Danh mục</option>
                                <?php if($header['categorySearch']): ?>
                                    <?php $__currentLoopData = $header['categorySearch']->childs()->orderby('order')->orderByDesc('created_at')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <option value="<?php echo e($item->id); ?>" <?php echo e(request()->input('category_id')==$item->id?"selected":""); ?>><?php echo e($item->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
                            <div class="search-header">
                                <form id="formSearch" name="formSearch" method="GET" action="<?php echo e(makeLink('search')); ?>">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="keyword" value="<?php echo e(request()->input('keyword')); ?>" placeholder="Nhập từ khóa tìm kiếm...">
                   ...
                   <div class="compare">
                        <ul>
                            <li>
                                <a href="<?php echo e(route('compare.list')); ?>">
									...
									<span>So sánh</br> sản phẩm</span> (<strong class="countCompare"><?php echo e($header['totalCompareQuantity']); ?></strong>)
                                </a>
                            </li>
                        </ul>
                   </div>
                        ...
                        <div class="box-header-bottom">
                            ...
                            <div class="menu menu-desktop">
                                    ...
                                    <ul class="nav-main">
                                        ...
                                        <?php echo $__env->make('frontend.components.menu-2',[
                                            'limit'=>3,
                                            'icon_d'=>'<i class="fa fa-angle-down"></i>',
                                            'icon_r'=>"<i class='fa fa-angle-right'></i>",
                                            'data'=>$header['menu-mega'],
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="box-search-header-main">
                                ...
                                <select name="category_id" form="formSearchMb" class="form-control">
                                    <option value="0">Danh mục</option>
                                    <?php if($header['categorySearch']): ?>
                                        <?php $__currentLoopData = $header['categorySearch']->childs()->orderby('order')->orderByDesc('created_at')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /var/www/vhosts/magnus-pro.com.vn/httpdocs/resources/views/frontend/partials/header.blade.php ENDPATH**/ ?>