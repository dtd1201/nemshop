          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
             ...
             <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                   ...
                   <li class="nav-item">
                      <a href="<?php echo e(route('admin.bank.create')); ?>" class="nav-link">
                         <i class="far fa-circle nav-icon"></i>
                         <p>Thêm ngân hàng</p>
                      </a>
                   </li>
             ...
             <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                   ...
                   <li class="nav-item">
                    <a href="<?php echo e(route('admin.user_frontend.listNoActive')); ?>" class="nav-link">
                       <i class="far fa-circle nav-icon"></i>
             ...
             <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                   <li class="nav-item">
                      <a href="<?php echo e(route('admin.pay.index')); ?>" class="nav-link">
                         <i class="far fa-circle nav-icon"></i>
...
<?php /**PATH D:\xampp\htdocs\php-laravel\web_tinh_toan\project_1\resources\views/admin/partials/sidebar.blade.php ENDPATH**/ ?>