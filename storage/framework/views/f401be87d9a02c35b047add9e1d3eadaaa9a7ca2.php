...
unset($__errorArgs, $__bag); ?>" id="model_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('model_'.$langItem['value'])); ?>" name="model_<?php echo e($langItem['value']); ?>" placeholder="Nhập thương hiệu">
                                                                    <?php $__errorArgs = ['model_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="tinhtrang_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('tinhtrang_'.$langItem['value'])); ?>" name="tinhtrang_<?php echo e($langItem['value']); ?>" placeholder="Nhập trạng thái">
                                                                    <?php $__errorArgs = ['tinhtrang_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="baohanh_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('baohanh_'.$langItem['value'])); ?>" name="baohanh_<?php echo e($langItem['value']); ?>" placeholder="Khuyến mại đặc biệt">
                                                                    <?php $__errorArgs = ['baohanh_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="content4_<?php echo e($langItem['value']); ?>" id="" rows="3"  placeholder="Nhập giới thiệu phải"><?php echo e(old('content4_'.$langItem['value'])); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('size')); ?>" name="size" placeholder="Nhập kích thước">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="">Thêm kích thước   <a data-url="<?php echo e(route('admin.product.loadOptionProduct')); ?>" class="btn  btn-info btn-md float-right " id="addOptionProduct">+ Thêm option</a></div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/largevendor.com/demo4.largevendor.com/resources/views/admin/pages/product/add.blade.php ENDPATH**/ ?>