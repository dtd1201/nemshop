<?php $__env->startSection('title', 'NABEI - Trao giá trị - vững niềm tin'); ?>
    ...
    <div class="content-wrapper">
        <div class="main">
            ...
            <div class="bg-home">
				...
				<div class="sale_home">
					<img src="<?php echo e(asset($collection->image_path)); ?>" alt="<?php echo e($collection->name); ?>">
				</div>
			<div class="wrap-pro-tab-home">
                    <div class="container">
                        <div class="row">
        ...
        <div class="modal fade modal-First" id="modal-first" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content" style="background-image: url(<?php echo e(asset($modalHome->image_path)); ?>);">
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo.dkcauto.net/httpdocs/resources/views/frontend/pages/home.blade.php ENDPATH**/ ?>