...
unset($__errorArgs, $__bag); ?>" value="1" name="bo_suu_tap" <?php if(old('bo_suu_tap')==="1" ): ?> <?php echo e('checked'); ?> <?php endif; ?>>
                                                </label>
                                            </div>
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" min="0" class="form-control  <?php $__errorArgs = ['colorOption.'.$key];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid  <?php unset($message);
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/sieuthithoitrangcaocap.com/httpdocs/resources/views/admin/pages/product/add.blade.php ENDPATH**/ ?>