                                    ...
                                    <div class="side-bar">
                                        <div class="banner_right">
                                            <div class="banner_home">
                                                <a><img src="<?php echo e($value->image_path); ?>" alt="<?php echo e($value->name); ?>"></a>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <div class="cate-right-item-box box-full u-flex">
                                                                <a href="<?php echo e($link); ?>" class=" align-items-center txt-gray-800 p-y-4 bg-gray-100 ">
                                                                    <div class="cate-right-item-img">
                                                                        <picture>
                                                                            <img alt="<?php echo e($categoryChild->name); ?>" srcset="" class="loaded" src="<?php echo e(asset($categoryChild->icon_path)); ?>" />
                                                                        </picture>
                                                                    </div>
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/cus05.largevendor.com/httpdocs/resources/views/frontend/pages/product-by-category.blade.php ENDPATH**/ ?>