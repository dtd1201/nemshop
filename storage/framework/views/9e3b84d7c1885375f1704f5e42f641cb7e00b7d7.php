			...
			<div class="container">
				<div class="row">
					<div class="col-12 col-sm-12 col-lg-12">
						<iframe src="/fix-html/prescription.html" style="border: 0px;margin: 0px;padding: 0px;width: 100%;height: 100%;min-height:1360px;top: 0px;left: 0px;"></iframe>
					</div>
				</div>
			</div>
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo.largevendor.com/httpdocs/resources/views/frontend/pages/drugstore/prescription.blade.php ENDPATH**/ ?>