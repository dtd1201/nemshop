...
unset($__errorArgs, $__bag); ?>" id="model_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('model_'.$langItem['value'])); ?>" name="model_<?php echo e($langItem['value']); ?>" placeholder="Nhập model">
                                                                    <?php $__errorArgs = ['model_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="tinhtrang_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('tinhtrang_'.$langItem['value'])); ?>" name="tinhtrang_<?php echo e($langItem['value']); ?>" placeholder="Nhập tình trạng">
                                                                    <?php $__errorArgs = ['tinhtrang_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="baohanh_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('baohanh_'.$langItem['value'])); ?>" name="baohanh_<?php echo e($langItem['value']); ?>" placeholder="Nhập bảo hành">
                                                                    <?php $__errorArgs = ['baohanh_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="xuatsu_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('xuatsu_'.$langItem['value'])); ?>" name="xuatsu_<?php echo e($langItem['value']); ?>" placeholder="Nhập xuất sứ">
                                                                    <?php $__errorArgs = ['xuatsu_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="content2_<?php echo e($langItem['value']); ?>" id="" rows="20" value=""  placeholder="Nhập thông số kỹ thuật" >
                                                                    <?php echo e(old('content2_'.$langItem['value'])); ?>
...
unset($__errorArgs, $__bag); ?>" name="content3_<?php echo e($langItem['value']); ?>" id="" rows="20" value=""  placeholder="Nhập chính sách vận chuyển" >
                                                                    <?php echo e(old('content3_'.$langItem['value'])); ?>
...
unset($__errorArgs, $__bag); ?>" name="content4_<?php echo e($langItem['value']); ?>" id="" rows="20" value=""  placeholder="Nhập chính sách bảo hành" >
                                                                    <?php echo e(old('content4_'.$langItem['value'])); ?>
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('sale')); ?>" name="sale" placeholder="Nhập sale">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\web_tinh_toan\vision-2\mayphotophuson.vn\resources\views/admin/pages/product/add.blade.php ENDPATH**/ ?>