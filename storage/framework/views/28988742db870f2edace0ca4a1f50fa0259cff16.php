...
<div class="content-wrapper lb_template_categoryproduct_edit">
    <?php echo $__env->make('admin.partials.content-header',['name'=>"Danh mục sản phẩm","key"=>"Sửa danh mục sản phẩm"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(route('admin.categoryproduct.update',['id'=>$data->id])); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card card-outline card-primary">
                                    ...
                                    <div class="card-body table-responsive p-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" value="<?php echo e($data->name); ?>" name="name" placeholder="Nhập tên danh mục sản phẩm" required="required">
...
unset($__errorArgs, $__bag); ?>
                                            <img src="<?php echo e(asset($data->icon_path)); ?>" alt="<?php echo e($data->name); ?>" class="img-load border p-1 w-30" style="height: 80px;object-fit:contain;">
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                                            <img src="<?php echo e(asset($data->avatar_path)); ?>" alt="<?php echo e($data->name); ?>" class="img-load border p-1 w-100" style="height: 200px;object-fit:cover;">
                                        </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\webbanhang\resources\views/admin/pages/categoryproduct/edit.blade.php ENDPATH**/ ?>