                                        ...
                                        <td><?php echo e($productstar->id); ?></td>
                                         ...
                                         <td>
                                            <?php if(isset($image->image_path)): ?>
                                              <img src="<?php echo e(asset($image->image_path)); ?>" alt="<?php echo e($productstar->name); ?>" style="width:80px;">
                                            <?php else: ?>
                                              <img src="<?php echo e(asset($shareFrontend['noImage'])); ?>" alt="No Image" style="width:80px;">
                                            <?php endif; ?>
                                          </td>
                                         <td>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo.largevendor.com/httpdocs/resources/views/admin/pages/productstar/index.blade.php ENDPATH**/ ?>