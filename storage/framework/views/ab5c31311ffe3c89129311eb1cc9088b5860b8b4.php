                                    ...
                                    <div class="col-12 col-sm-6 col-md-6 col-lg-3 col-blog-news">
                                        <div class="box">
                                            <div class="news-image">
                                                <a href="<?php echo e($value->slug); ?>">
                                                    <img src="<?php echo e(asset($value->avatar_path)); ?>" alt="<?php echo e($value->name); ?>">
                                                </a>
                                            </div>
                                            <div class="news-content">
                                                <div class="news-content-title">
                                                    <a href="<?php echo e($value->slug); ?>"><?php echo e($value->name); ?></a>
                                                </div>
                                                <ul>
                                                    <?php if($value->childs()->count() > 0): ?>
                                                        <?php $__currentLoopData = $value->childs()->where('active', 1)->orderBy('order')->limit(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li>
                                                                <a href="<?php echo e($childValue->slug); ?>">
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo.largevendor.com/httpdocs/resources/views/frontend/pages/post-by-category.blade.php ENDPATH**/ ?>