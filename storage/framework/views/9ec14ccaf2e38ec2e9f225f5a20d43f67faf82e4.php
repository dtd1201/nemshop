                                    ...
                                    <div class="order-content">
                                        ...
                                        <div class="infor-order mb-3">
                                            ...
                                            <ul class="list-infor">
                                                ...
                                                <li><span><?php echo e(__('contact.address')); ?> </span> <?php echo e($data->address_detail); ?>, <?php echo e($data->commune->name); ?>, <?php echo e($data->district->name); ?>, <?php echo e($data->city->name); ?> (<?php echo e(__('contact.xac_nhan')); ?>).</li>
                                                ...
                                                <li><span><?php echo e(__('Ghi chú')); ?> </span> <?php echo e($data->note); ?></li>
                                            </ul>
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/food.mauwebsite.asia/httpdocs/resources/views/frontend/pages/order-sucess.blade.php ENDPATH**/ ?>