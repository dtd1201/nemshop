...
unset($__errorArgs, $__bag); ?>
                                            <div class="load-multiple-img">
                                                ...
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(!$data->getImages()->get()->count()): ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\webbanhang\resources\views/admin/pages/product/edit.blade.php ENDPATH**/ ?>