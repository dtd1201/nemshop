...
?>
  ...
  <ul class="nav-main">
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <li class="nav-item <?php if($loop->first&&$active): ?> active <?php endif; ?>">
            <a href="<?php echo e($value['slug_full']); ?>"><span><?php echo e($value['name']); ?></span>
...
<?php /**PATH D:\xampp\htdocs\php-laravel\web_tinh_toan\vision-2\mayphotophuson.vn\resources\views/frontend/components/menu.blade.php ENDPATH**/ ?>