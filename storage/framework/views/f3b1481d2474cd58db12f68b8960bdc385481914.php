            ...
            <div class="col-md-12">
                ...
                <div class="d-flex justify-content-end">
                   <div class="text-right w-100">
                    <a href="<?php echo e(route('admin.categoryproduct.create',['parent_id'=>request()->parent_id??0])); ?>" class="btn  btn-info btn-md mb-2">+ Thêm mới</a>
                   </div>
                ...
                <div class="card card-outline card-primary">
                    <div class="card-body table-responsive lb-list-category" style="padding: 0; font-size:13px;">
                        <?php echo $__env->make('admin.components.danh-muc-san-pham', [
                            'data' => $data,
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo5.tiemthietke.com/httpdocs/resources/views/admin/pages/categoryproduct/list.blade.php ENDPATH**/ ?>