                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3 mb-0" style="min-width:100px;">
                                                <select id="" name="fill_action" class="form-control">
                                                    ...
                                                    <option value="hot" <?php echo e($fill_action=='hot'? 'selected':''); ?>>Sản phẩm bán chạy</option>
                                                    <option value="sp_km" <?php echo e($fill_action=='sp_km'? 'selected':''); ?>>Sản phẩm khuyến mại</option>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo5.tiemthietke.com/httpdocs/resources/views/admin/pages/product/list.blade.php ENDPATH**/ ?>