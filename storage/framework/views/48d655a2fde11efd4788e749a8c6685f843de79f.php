        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(route('admin.post.update',['id'=>$data->id])); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-8">
...
unset($__errorArgs, $__bag); ?>" id="name" value="<?php echo e($data->name); ?>" name="name" placeholder="Nhập tên bài viết">
                                                <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="slug" value="<?php echo e($data->slug); ?>" name="slug" placeholder="Nhập slug">
                                            </div>
                                            <?php $__errorArgs = ['slug'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>" id="" name="category_id">
...
unset($__errorArgs, $__bag); ?>" value="1" name="hot" <?php if( $data->hot ==1): ?> <?php echo e('checked'); ?> <?php endif; ?>
                                                    >
                                                </label>
                                            </div>
                                        </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\webbanhang\resources\views/admin/pages/post/edit.blade.php ENDPATH**/ ?>