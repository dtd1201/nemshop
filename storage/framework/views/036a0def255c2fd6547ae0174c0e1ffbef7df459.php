<?php $__env->startSection('title',"Thêm câu hỏi"); ?>

<?php $__env->startSection('content'); ?>
<div class="content-wrapper">
   <?php echo $__env->make('admin.partials.content-header',['name'=>"Câu hỏi","key"=>"Thêm câu hỏi"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
   <!-- Main content -->
   <div class="content">
      <div class="container-fluid">
         <div class="row">
            <div class="col-md-12">
               ...
               <?php endif; ?>
               <form action="<?php echo e(route('admin.question.store')); ?>" method="POST" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="name_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('name_'.$langItem['value'])); ?>" name="name_<?php echo e($langItem['value']); ?>" placeholder="Nhập tiêu đề">
                                                            <?php $__errorArgs = ['name_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <textarea type="text" class="form-control resultSlug
...
unset($__errorArgs, $__bag); ?>" id="slug_<?php echo e($langItem['value']); ?>" rows="5" name="value_<?php echo e($langItem['value']); ?>" placeholder="Nhập nôi dung"><?php echo e(old('slug_'.$langItem['value'])); ?></textarea>
                                                            <?php $__errorArgs = ['value_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo.largevendor.com/httpdocs/resources/views/admin/pages/question/add.blade.php ENDPATH**/ ?>