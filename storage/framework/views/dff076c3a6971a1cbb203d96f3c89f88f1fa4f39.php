...
unset($__errorArgs, $__bag); ?>" >
                                    ...
                                    <div class="form-err txt-left" style="display: none;">
                                        <div class="alert alert-md alert-danger alert-des alert-sm-md ">
                                             <i class="fas fa-minus alert-ic bg-danger"></i>
                                            <span class="">Thông tin bắt buộc</span>
                                        </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\demola\resources\views/frontend/components/cart-component.blade.php ENDPATH**/ ?>