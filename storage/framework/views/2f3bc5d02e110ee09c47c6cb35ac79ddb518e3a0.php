          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
             ...
             <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                 ...
                 <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product-list')): ?>
                  <li class="nav-item">
                    <a href="<?php echo e(route('admin.comment.index',['type_comment'=> 2])); ?>" class="nav-link">
                       <i class="fas fa-angle-double-right"></i>
...
<?php /**PATH /var/www/vhosts/demo5.tiemthietke.com/httpdocs/resources/views/admin/partials/sidebar.blade.php ENDPATH**/ ?>