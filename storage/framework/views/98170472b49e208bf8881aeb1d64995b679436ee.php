...
<?php $__env->startSection('content'); ?>
  <div class="content-wrapper lb_template_post_edit">
    <?php echo $__env->make('admin.partials.content-header',['name'=>"Post","key"=>"Edit post"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
              ...
              <?php endif; ?>
              <form action="<?php echo e(route('admin.post.postEdit',['id'=>$data->id])); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="form-group">
                    ...
                    <input
                        type="mumber"
                        class="form-control <?php $__errorArgs = ['view'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                value="1"
                                name="hot"
                                <?php if( $data->hot ==1): ?> <?php echo e('checked'); ?>  <?php endif; ?>
                            >
                      </label>
                    </div>
                  </div>
...
unset($__errorArgs, $__bag); ?>"
                        id=""
                        value="<?php echo e($data->description_seo); ?>"
...
unset($__errorArgs, $__bag); ?>"
                        id=""
                        value="<?php echo e($data->title_seo); ?>"
                        name="title_seo"
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\webbanhang\resources\views/admin/page/post/edit.blade.php ENDPATH**/ ?>