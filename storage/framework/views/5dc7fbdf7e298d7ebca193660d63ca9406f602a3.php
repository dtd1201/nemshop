...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control nameChangeSlug
                                                                    <?php $__errorArgs = ['model_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="model_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('model_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->model); ?>" name="model_<?php echo e($langItem['value']); ?>" placeholder="Nhập model">
                                                                    <?php $__errorArgs = ['model_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control nameChangeSlug
                                                                    <?php $__errorArgs = ['tinhtrang_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="tinhtrang_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('tinhtrang_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->tinhtrang); ?>" name="tinhtrang_<?php echo e($langItem['value']); ?>" placeholder="Nhập tinhtrang">
                                                                    <?php $__errorArgs = ['tinhtrang_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control nameChangeSlug
                                                                    <?php $__errorArgs = ['baohanh_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="baohanh_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('baohanh_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->baohanh); ?>" name="baohanh_<?php echo e($langItem['value']); ?>" placeholder="Nhập baohanh">
                                                                    <?php $__errorArgs = ['baohanh_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control nameChangeSlug
                                                                    <?php $__errorArgs = ['xuatsu_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="xuatsu_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('xuatsu_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->xuatsu); ?>" name="xuatsu_<?php echo e($langItem['value']); ?>" placeholder="Nhập xuất sứ">
                                                                    <?php $__errorArgs = ['xuatsu_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <textarea class="form-control tinymce_editor_init <?php $__errorArgs = ['content2_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid  <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="content2_<?php echo e($langItem['value']); ?>" id="" rows="20" value="" placeholder="Nhập thông số kỹ thuật">
                                                                    <?php echo e(old('content2_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->content); ?>

                                                                    </textarea>
                                                                    <?php $__errorArgs = ['content2_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <textarea class="form-control tinymce_editor_init <?php $__errorArgs = ['content3_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid  <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="content3_<?php echo e($langItem['value']); ?>" id="" rows="20" value="" placeholder="Nhập chính sách vận chuyển">
                                                                    <?php echo e(old('content3_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->content); ?>

                                                                    </textarea>
                                                                    <?php $__errorArgs = ['content3_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <textarea class="form-control tinymce_editor_init <?php $__errorArgs = ['content4_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid  <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="content4_<?php echo e($langItem['value']); ?>" id="" rows="20" value="" placeholder="Nhập chính sách bảo hành">
                                                                    <?php echo e(old('content4_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->content); ?>

                                                                    </textarea>
                                                                    <?php $__errorArgs = ['content4_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" class="form-control  <?php $__errorArgs = ['sale'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid  <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('sale')??$data->sale); ?>" name="sale" placeholder="Nhập sale">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div>
                                            <a href="<?php echo e($data->file); ?>" download><?php echo e($data->file); ?></a>
                                          </div>
                                            <input type="file" class="form-control-file img-load-input border <?php $__errorArgs = ['file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" id="" name="file">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <a href="<?php echo e($data->file2); ?>" download><?php echo e($data->file2); ?></a>
                                            </div>
                                            <input type="file" class="form-control-file img-load-input border <?php $__errorArgs = ['file2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" id="" name="file2">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <a href="<?php echo e($data->file3); ?>" download><?php echo e($data->file3); ?></a>
                                            </div>
                                            <input type="file" class="form-control-file img-load-input border <?php $__errorArgs = ['file3'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" id="" name="file3">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\web_tinh_toan\vision-2\mayphotophuson.vn\resources\views/admin/pages/product/edit.blade.php ENDPATH**/ ?>