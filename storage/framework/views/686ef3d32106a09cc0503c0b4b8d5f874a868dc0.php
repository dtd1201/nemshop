        ...
        <div class="box-left lb_list_content_recusive">
            <div class="d-flex">
                ...
                <div class="col-sm-3 pt-2 pb-2 slug">
                    <?php echo e($childValue->description); ?>

                </div>
                <div class="col-sm-3 pt-2 pb-2 slug">
                    <?php echo e($childValue->key_code); ?>
    ...
    <?php if($childValue->childs->count()): ?>
        <ul class="" style="display: none;">
            <?php $__currentLoopData = $childValue->childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childValue2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo $__env->make('admin.components.permission-child', ['childValue' => $childValue2], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </ul>
    <?php endif; ?>
</li>

<?php /**PATH D:\xampp\htdocs\php-laravel\web_tinh_toan\vision-2\mayphotophuson.vn\resources\views/admin/components/permission-child.blade.php ENDPATH**/ ?>