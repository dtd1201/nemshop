      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">           
              ...
              <?php endif; ?>
              <form action="<?php echo e(route('admin.category.product.postEdit',['id'=>$data->id])); ?>" method="POST">
                <?php echo csrf_field(); ?>
                  <div class="form-group">
                  <label for="">Tên danh mục</label>
                  <input type="text" class="form-control" id="" value="<?php echo e($data->name); ?>"  name="name" placeholder="Nhập tên danh mục">
...
unset($__errorArgs, $__bag); ?>
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control"  id="" value="<?php echo e($data->icon); ?>" name="icon" >
                  </div>
...
unset($__errorArgs, $__bag); ?>
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control"  id="" value="<?php echo e($data->avatar); ?>" name="avatar" >
                  </div>
...
unset($__errorArgs, $__bag); ?>
                  <div class="form-group">
                    <div class="form-check-inline">
                      ...
                      <input type="radio" class="form-check-input" value="1" name="active" <?php if( $data->active==="1"||old('active')===null): ?> <?php echo e('checked'); ?>  <?php endif; ?>>Active
                      </label>
                    </div>
                    <div class="form-check-inline">
                      <label class="form-check-label">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\php-laravel\webbanhang\resources\views/admin/page/categoryproduct/edit.blade.php ENDPATH**/ ?>