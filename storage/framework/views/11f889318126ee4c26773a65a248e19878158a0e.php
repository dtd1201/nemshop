            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-12">
                        <ul>
                            <li class="a"><?php echo e($header['thuong_hieu']->name); ?></li>
                            <li class="d"><a href="<?php echo e($header['tai_sao']->slug); ?>" rel="nofollow"><?php echo e($header['tai_sao']->name); ?></a></li>
                        </ul>
            ...
            <div class="container">
                <div class="box-header-main">
                    ...
                    <div class="hotline_kh">
                        <?php echo $header['hotline_top']->description; ?>
...
<?php /**PATH /var/www/vhosts/largevendor.com/demo4.largevendor.com/resources/views/frontend/partials/header.blade.php ENDPATH**/ ?>