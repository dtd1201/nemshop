            ...
            <div class="col-md-12">
                ...
                <div class="d-flex justify-content-between ">
                    ...
                    <div class="group-button-right d-flex">
                        <form action="<?php echo e(route('admin.post.import.excel.database')); ?>" class="form-inline" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                        ...
                        <form class="form-inline ml-3" action="<?php echo e(route('admin.post.export.excel.database')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                        ...
                        <div class="card-tools w-100 mb-3">
                            <form action="<?php echo e(route('admin.post.index')); ?>" method="GET">
                                <div class="row">
                                    ...
                                    <div class="col-md-1 mb-0">
                                        <a  class="btn btn-danger w-100" href="<?php echo e(route('admin.post.index')); ?>">Reset</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <table class="table table-head-fixed" style="font-size:13px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($postItem->view); ?></td>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\webbanhang\resources\views/admin/pages/post/list.blade.php ENDPATH**/ ?>