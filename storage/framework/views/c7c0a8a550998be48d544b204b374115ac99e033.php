      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <?php endif; ?>
            <a href="<?php echo e(route('admin.categorypost.getAdd')); ?>" class="btn btn-success">Add</a>
            </div>
            <div class="col-md-12">
                <div class="lb-list-category">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <td>
                                <a href="<?php echo e(route('admin.categorypost.getEdit',['id'=>$key->id])); ?>" class="btn btn-success">Edit</a>
                                <a data-url="<?php echo e(route('admin.categorypost.getDelete',['id'=>$key->id])); ?>" class="btn btn-danger lb_delete">Delete</a>
                            </td>
                            </tr>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\webbanhang\resources\views/admin/page/categorypost/list.blade.php ENDPATH**/ ?>