          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
             ...
             <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                   ...
                   <?php endif; ?>
                   <li class="nav-item">
                     <a href="<?php echo e(route('admin.variant.index')); ?>" class="nav-link">
                        <i class="fas fa-angle-double-right"></i>
                        <p>Biến thể sản phẩm
                        <i class="right fas fa-angle-right"></i>
                        </p>
                     ...
                     <ul class="nav nav-treeview">
                        <li class="nav-item">
                           <a href="<?php echo e(route('admin.variant-value.index')); ?>" class="nav-link">
                              <i class="fas fa-angle-double-right"></i>
...
<?php /**PATH /var/www/vhosts/sieuthithoitrangcaocap.com/httpdocs/resources/views/admin/partials/sidebar.blade.php ENDPATH**/ ?>