                        ...
                        <div class="col-xs-12">
                            <div class="group-title">
                                <div class="title title-red">
                                  <?php echo e(__('product.danh_muc_cac_dich_vu')); ?>
                            ...
                            <div class="text-center">
                                <a href="<?php echo e(makeLinkToLanguage('bao-gia',null,null,App::getLocale())); ?>" class="btn-view"><i class="fa fa-paper-plane" aria-hidden="true"></i> <?php echo e(__('product.nhan_tu_van')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\web_tinh_toan\vision-2\backuptan\resources\views/frontend/pages/product.blade.php ENDPATH**/ ?>