            ...
            <div class="wrap-content-main">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('profile.updateInfo',['id'=>$data->id])); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                                        <img class="img-load border p-1 w-100" src="<?php echo e($data->avatar_path?$data->avatar_path:$shareFrontend['userNoImage']); ?>" alt="<?php echo e($data->name); ?>" style="height: auto;width:auto;max-width:150px;object-fit:cover;">
                                                    </div>
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('name')?? $data->name); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        value="<?php echo e(old('username')?? $data->username); ?>" name="username" placeholder="username">
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        value="<?php echo e(old('phone')?? $data->phone); ?>" name="phone" placeholder="Số điện thoại">
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        value="<?php echo e(old('date_birth')?? $data->date_birth); ?>" name="date_birth" placeholder="Ngày sinh">
...
unset($__errorArgs, $__bag); ?>" data-url="<?php echo e(route('ajax.address.communes')); ?>"  required="required">
                                                            ...
                                                            <?php if(isset($districts) && $districts->count()>0): ?>
                                                                ...
                                                                <option value="<?php echo e($item->id); ?>" <?php if($data->district_id == $item->id): ?> selected <?php endif; ?>><?php echo e($item->name); ?></option>
...
unset($__errorArgs, $__bag); ?>"  required="required">
                                                            ...
                                                            <?php if(isset($communes) && $communes->count()>0): ?>
                                                                ...
                                                                <option value="<?php echo e($item->id); ?>" <?php if($data->commune_id == $item->id): ?> selected <?php endif; ?>><?php echo e($item->name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            <?php endif; ?>
                                                        </select>
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        value="<?php echo e(old('address')?? $data->address); ?>" name="address" placeholder="Địa chỉ">
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        value="<?php echo e(old('hktt')?? $data->hktt); ?>" name="hktt" placeholder="Hộ khẩu thường trú">
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        value="<?php echo e(old('cmt')?? $data->cmt); ?>" name="cmt" placeholder="Chứng minh thư">
                                                        <?php $__errorArgs = ['cmt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        value="<?php echo e(old('stk')??  $data->stk); ?>" name="stk" placeholder="Số tài khoản">
                                                        <?php $__errorArgs = ['stk'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        value="<?php echo e(old('ctk')?? $data->ctk); ?>" name="ctk" placeholder="Chủ tài khoản">
                                                        <?php $__errorArgs = ['ctk'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="bank_id" class="form-control" id="">
                                                            ...
                                                            <option value="<?php echo e($bank->id); ?>" <?php echo e((old('bank_id')?? $data->bank_id)==$bank->id ?'selected':''); ?>><?php echo e($bank->name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        value="<?php echo e(old('bank_branch')?? $data->bank_branch); ?>" name="bank_branch" placeholder="Tên chi nhánh ngân hàng">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-check-inline">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="1" name="sex" <?php if((old('sex')?? $data->sex)=="1"||$data->sex==null): ?> <?php echo e('checked'); ?> <?php endif; ?> >Nam
                                                            </label>
                                                        </div>
                                                        <div class="form-check-inline">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="0" <?php if( (old('sex')?? $data->sex)=="0"): ?><?php echo e('checked'); ?> <?php endif; ?> name="sex" >Nữ
                                                            </label>
                                                        </div>
                                                        <?php $__errorArgs = ['sex'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
unset($__errorArgs, $__bag); ?>
                                                        <img class="img-load border p-1 w-100" src="<?php echo e($data->image_cmt_before ? asset($data->image_cmt_before) :$shareFrontend['userNoImage']); ?>" alt="<?php echo e($data->name); ?>" style="height: auto;width:auto;max-width:150px;object-fit:cover;">
                                                    </div>
                                                    <div class="wrap-load-image mb-3">
                                                        <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                                                        <img class="img-load border p-1 w-100" src="<?php echo e($data->image_cmt_after ? asset($data->image_cmt_after) :$shareFrontend['userNoImage']); ?>" alt="<?php echo e($data->name); ?>" style="height: auto;width:auto;max-width:150px;object-fit:cover;">
                                                    </div>
...
<?php echo $__env->make('frontend.layouts.main-profile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo.largevendor.com/httpdocs/resources/views/frontend/pages/profile-edit-info.blade.php ENDPATH**/ ?>