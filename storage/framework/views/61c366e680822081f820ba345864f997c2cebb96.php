					...
					<div class="col-md-4 col-sm-6 col-12">
					   <div class="info-box">
						  ...
						  <div class="info-box-content">
							 <span class="info-box-text">Bài viết Tuyển dụng</span>
		  ...
		  <div class="row">
            <div class="col-md-6">
               <div class="card card-outline card-primary">
                  <div class="card-header">
                     <h3 class="card-title">10 vị trí thêm gần đây</h3>
                  </div>
                  <!-- /.card-header -->
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\demola\resources\views/admin/pages/index.blade.php ENDPATH**/ ?>