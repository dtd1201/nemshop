...
<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        <?php echo $__env->make('admin.partials.content-header',['name'=>"Setting","key"=>"Sửa nội dung"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <label class="col-sm-2 control-label" for="">Điện thoại</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control
                                                                <?php $__errorArgs = ['content1_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid  <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="content1_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('content1_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->content1); ?>" name="content1_<?php echo e($langItem['value']); ?>" placeholder="Nhập số điện thoại">
                                                                <?php $__errorArgs = ['content1_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="content2_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('content2_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->content2); ?>" name="content2_<?php echo e($langItem['value']); ?>" placeholder="Nhập thời gian">
                                                                <?php $__errorArgs = ['content2_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <label class="col-sm-2 control-label" for="">Chat zalo</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control
...
unset($__errorArgs, $__bag); ?>" id="content3_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('content3_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->content3); ?>" name="content3_<?php echo e($langItem['value']); ?>" placeholder="zalo">
                                                                <?php $__errorArgs = ['content3_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <textarea class="form-control  <?php $__errorArgs = ['value_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="value_<?php echo e($langItem['value']); ?>" id="" rows="3"  placeholder="Nhập giới thiệu"><?php echo e(old('value_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->value); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" name="description_<?php echo e($langItem['value']); ?>" id="" rows="20" value="" placeholder="Nhập nội dung">
...
unset($__errorArgs, $__bag); ?>" id="" value="<?php echo e(old('parent_id')); ?>" name="parent_id">
                                                    ...
                                                    <?php echo \App\Models\Setting::getHtmlOptionAddWithParent(old('parent_id')); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo.largevendor.com/httpdocs/resources/views/admin/pages/setting/edit.blade.php ENDPATH**/ ?>