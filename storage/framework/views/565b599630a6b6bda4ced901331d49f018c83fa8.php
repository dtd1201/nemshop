                                ...
                                <h1 class="title-template-in">
                                    ...
                                    <div class="img_about">
                                        <a href="<?php echo e($category->description); ?>">
                                            <img src="<?php echo e(asset($category->avatar_path)); ?>" alt="<?php echo e($category->name); ?>">
                                        </a>
                                    </div>
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo.dkcauto.net/httpdocs/resources/views/frontend/pages/post-by-category.blade.php ENDPATH**/ ?>