                                    ...
                                    <div class="order-content">
                                        ...
                                        <div class="infor-order mb-3">
                                            <div class="thank-you text-center mb-3">
                                             Cảm ơn quý khách  đã đặt hàng tại Thế giới di động
                                            </div>
                                            <ul class="list-infor">
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\webbanhang\resources\views/frontend/pages/order-sucess.blade.php ENDPATH**/ ?>