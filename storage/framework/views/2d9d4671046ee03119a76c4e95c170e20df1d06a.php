                            ...
                            <div class="contact-form">
                                <div class="form" >
                                    ...
                                    <form  action="<?php echo e(route('contact.storeAjax')); ?>"  data-url="<?php echo e(route('contact.storeAjax')); ?>" data-ajax="submit" data-target="alert" data-href="#modalAjax" data-content="#content" data-method="POST" method="POST">
                                        ...
                                        <input type="text" placeholder="<?php echo e(__('contact.email')); ?>" required="required" name="email">
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/cus01.largevendor.com/httpdocs/resources/views/frontend/pages/contact.blade.php ENDPATH**/ ?>