                                    ...
                                    <div class="col-12 col-sm-6 col-md-6 col-lg-3 col-blog-news">
                                        <div class="box">
                                            ...
                                            <div class="news-content">
                                                ...
                                                <ul>
                                                    <?php if($value->childs()->count() > 0): ?>
                                                        <?php $__currentLoopData = $value->childs()->where('active', 1)->orderBy('order')->limit(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li>
                    ...
                    <div class="block-news">
                        <div class="section-btg">
                            <div class="container">
                                <h2 class="post-title"><?php echo e($category->name); ?></h2>
                                <div class="row">
                                    <?php $__currentLoopData = $category->posts()->where('active', 1)->orderBy('order')->limit(12)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-3 col-blog-news">
                                            <div class="box">
                                                <div class="news-image">
                                                    <a href="<?php echo e($value->slug_full); ?>">
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/thuoctot365.vn/httpdocs/resources/views/frontend/pages/post-by-category.blade.php ENDPATH**/ ?>