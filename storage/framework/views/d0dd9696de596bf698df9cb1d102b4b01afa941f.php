    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header"> <?php echo e(isset($url) ? ucwords($url) : ""); ?> <?php echo e(__('Đăng ký')); ?></div>
                <div class="card-body">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="username" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Tên đăng nhập')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo.largevendor.com/httpdocs/resources/views/auth/register.blade.php ENDPATH**/ ?>