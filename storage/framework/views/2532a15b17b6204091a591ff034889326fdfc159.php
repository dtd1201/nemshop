      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('admin.menu.update',['id'=>$data->id])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <img class="img-load border p-1 w-100" src="<?php echo e(asset($data->avatar_path)); ?>" alt="<?php echo e($data->name); ?>" style="object-fit:contain;">
                                        <?php endif; ?>
                                    </div>
                                    <div class="form-group">
...
unset($__errorArgs, $__bag); ?>" id="" value="<?php echo e(old('parent_id')); ?>" name="parent_id">
                                            ...
                                            <?php echo \App\Models\Menu::getHtmlOptionAddWithParent(old('parent_id')); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\web_tinh_toan\vision-2\backuptan\resources\views/admin/pages/menu/edit.blade.php ENDPATH**/ ?>