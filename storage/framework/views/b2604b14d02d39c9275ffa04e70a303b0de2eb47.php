                                                        ...
                                                        <div class="box">
                                                            ...
                                                            <div class="content">
                                                                <h3><a href="<?php echo e(makeLink('post',$post_item->id,$post_item->slug)); ?>"><?php echo e($post_item->name); ?></a></h3>
                                                                 <div class="date"><i class="far fa-calendar-alt"></i> <?php echo e(Illuminate\Support\Carbon::parse($post_item->created_at)->format('d/m/Y')); ?> - <?php echo e(__('post.dang_boi')); ?></div>
                                                                <div class="desc">
                                                                    <?php echo e($post_item->description); ?>

                                                                </div>
                                                               <div class="text-right">
                                                                <a href="<?php echo e(makeLink('post',$post_item->id,$post_item->slug)); ?>" class="btn-viewmore btn btn-light"><i class="fas fa-angle-double-right"></i> <?php echo e(__('post.xem_them')); ?></a>
                                                               </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/cus01.largevendor.com/httpdocs/resources/views/frontend/pages/post-by-category.blade.php ENDPATH**/ ?>