            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('admin.slider.update', ['id' => $data->id])); ?>" method="POST"
...
unset($__errorArgs, $__bag); ?>"
                                                    id="name" value="<?php echo e($data->name); ?>" name="name"
...
unset($__errorArgs, $__bag); ?>"
                                                    value="<?php echo e($data->slug); ?>" name="slug" placeholder="Nhập slug">
                                            </div>
...
unset($__errorArgs, $__bag); ?>
                                                <img class="img-load border p-1 w-100" src="<?php echo e($data->image_path); ?>"
                                                    alt="<?php echo e($data->name); ?>" style="height: 200px;object-fit:cover;">
                                            </div>
                                            <div class="form-group">
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" class="form-check-input" value="1" name="active"
                                                            <?php if($data->active === '1' || old('active') === null || old('active') === '1'): ?> <?php echo e('checked'); ?>  <?php endif; ?>>Hiện
                                                    </label>
                                                </div>
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" class="form-check-input" value="0"
                                                            <?php if($data->active === '0'): ?><?php echo e('checked'); ?>  <?php endif; ?> name="active">Ẩn
                                                    </label>
                                                </div>
                                            </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/cus05.largevendor.com/httpdocs/resources/views/admin/pages/slider/edit.blade.php ENDPATH**/ ?>