...
<div class="main-rte">
    <div class="breadcrum">
        <img src="<?php echo e(asset($data->avatar_path)); ?>" alt="<?php echo e($data->avatar_path); ?>">
    </div>
    <div class="rte">
        <div class="container">
            <div class="row">
                ...
                <div class="rte-recruiment_left col-xl-8 col-lg-8 col-md-8 col-12">
                    <div class="detail-job">
                        ...
                        <div class="detail-job-contact">
                            <h3 class="sub-title"><?php echo e($lien_he->name); ?></h3>
                            <?php if($lien_he->childs->count()>0): ?>
                            <ul class="detail-job_sum">
                                <?php $__currentLoopData = $lien_he->childs()->where('active', 1)->orderBy('order')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="job_sum_item"><?php echo e($item->name); ?>:<a href="<?php echo e($item->slug??'#'); ?>"> <?php echo e($item->value); ?></a></li>
                    ...
                    <div class="recruiment-form">
                        ...
                        <form id="recruiment-form" action="<?php echo e(route('contact.storeAjax')); ?>"  data-url="<?php echo e(route('contact.storeAjax')); ?>" data-ajax="submit" data-target="alert" data-href="#modalAjax" data-content="#content" data-method="POST" method="POST">
                            ...
                            <select name="job_name" id="choosejob">
                                ...
                                <option selected value="<?php echo e($data->name); ?>
                ...
                <?php if($dataRelate && $dataRelate->count()>0): ?>
                <div class="col-12">
                    <div class="recruitment-content-wrapper">
                        <article class="recruitment-content-container">
                            <h3 class="sub-title"><?php echo e($data->category->name); ?></h3>
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\demola\resources\views/frontend/pages/post-detail.blade.php ENDPATH**/ ?>