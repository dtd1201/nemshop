...
unset($__errorArgs, $__bag); ?>" id="" data-id="<?php echo e($i); ?>" name="image1[]" multiple>
                                ...
                                <?php $__currentLoopData = $data->stars()->where('hot', 1)->where('parent_id', 0)->orderBy('created_at')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $com): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="itemcmt">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo.largevendor.com/httpdocs/resources/views/frontend/pages/product-detail.blade.php ENDPATH**/ ?>