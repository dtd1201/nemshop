...
<?php $__env->startSection('content'); ?>
  ...
  <div class="content-wrapper">
    <?php echo $__env->make('admin.partials.content-header',['name'=>"Permission","key"=>"Sửa quyền"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="row">
            <div class="col-md-12">
              ...
              <div class="alert alert-warning">
                 <?php echo e(ssession("error")); ?>

              </div>
              <?php endif; ?>
              <form action="<?php echo e(route('admin.permission.postEdit',['id'=>$data->id])); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-md-8">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\webbanhang\resources\views/admin/pages/permission/edit.blade.php ENDPATH**/ ?>