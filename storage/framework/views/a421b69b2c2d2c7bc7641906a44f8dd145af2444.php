...
unset($__errorArgs, $__bag); ?>
							...
							<div class="form-group row mb-0">
								...
								<div class="col-md-8 offset-md-4">
									<div class="dang_ky">
										Nếu bạn chưa có tài khoản vui lòng đăng ký <a href="<?php echo e(route('register')); ?>">tại đây</a>
									</div>
								</div>
							</div>
						</form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo.largevendor.com/httpdocs/resources/views/auth/login.blade.php ENDPATH**/ ?>