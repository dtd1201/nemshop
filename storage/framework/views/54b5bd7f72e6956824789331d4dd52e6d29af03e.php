...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check-inline">
                                        ...
                                        <input type="radio" class="form-check-input" value="1" name="type" <?php if(old('type')==='1' || $data->type==1): ?> <?php echo e('checked'); ?> <?php endif; ?>>Mobile
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" value="0" <?php if(old('type')==="0" || $data->type==0): ?><?php echo e('checked'); ?> <?php endif; ?> name="type">Desktop
                                        </label>
                                    </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\demola\resources\views/admin/pages/slider/edit.blade.php ENDPATH**/ ?>