...
unset($__errorArgs, $__bag); ?>" id="baohanh_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('baohanh_'.$langItem['value'])); ?>" name="baohanh_<?php echo e($langItem['value']); ?>" placeholder="Nhập màu">
                                                                    <?php $__errorArgs = ['baohanh_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="xuatsu_<?php echo e($langItem['value']); ?>" value="<?php echo e(old('xuatsu_'.$langItem['value'])); ?>" name="xuatsu_<?php echo e($langItem['value']); ?>" placeholder="Nhập phụ kiện tặng kèm">
                                                                    <?php $__errorArgs = ['xuatsu_'.$langItem['value']];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="">Thêm option   <a data-url="<?php echo e(route('admin.product.loadOptionProduct')); ?>" class="btn  btn-info btn-md float-right " id="addOptionProduct">+ Thêm option</a></div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo.dkcauto.net/httpdocs/resources/views/admin/pages/product/add.blade.php ENDPATH**/ ?>