                                   ...
                                   <tr>
                                       ...
                                       <td>
                                           <ul>
                                              ...
                                              <li>
                                                <strong>Điện thoại:</strong>   <?php echo e($transaction->phone); ?>
                                              ...
                                              <li>
                                               ...
                                               <li>
                                                   <strong>Mã đơn:</strong>  <?php echo e($transaction->code); ?>

                                               </li>
                                              <?php if($transaction->time): ?>
                                              <li>
                                                <strong>Thời gian nhận:</strong> <?php echo e($transaction->time); ?>

                                              </li>
                                              <?php endif; ?>
                                              <?php if($transaction->name_orther): ?>
                                              <li>
                                                <strong>Tên người nhận khác:</strong>   <?php echo e($transaction->name_orther); ?>

                                              </li>
                                              <?php endif; ?>
                                              <?php if($transaction->phone_orther): ?>
                                              <li>
                                                <strong>Điện thoại người nhận khác:</strong>   <?php echo e($transaction->phone_orther); ?>

                                              </li>
                                              <?php endif; ?>
                                              <?php if($transaction->address_orther): ?>
                                              <li>
                                                <strong>Địa chỉ người nhận khác:</strong>   <?php echo e($transaction->address_orther); ?>
                                       ...
                                       <td>
                                           ...
                                           <ul>
                                              <li>
                                                <strong>Giá trị đơn hàng:</strong>  <span class="text-danger"><?php echo e(number_format($transaction->total)); ?>đ</span>
                                              </li>
                                          </ul>
                                        </td>
                                       ...
                                       <td>
                                        <a class="btn btn-sm btn-info p-1" id="btn-load-transaction-detail" data-url="<?php echo e(route('profile.transaction.detail',['id'=>$transaction->id])); ?>" >Chi tiết</a>
                                        </td>
                                    </tr>
                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('frontend.layouts.main-profile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo.largevendor.com/httpdocs/resources/views/frontend/pages/profile-history.blade.php ENDPATH**/ ?>