...
<?php $__env->startSection('css'); ?>
    <style>
         .lb_template_categorypost_edit img{
            width: 200px;
            height: auto;
            object-fit: cover;
        }
...
<?php $__env->startSection('content'); ?>
  ...
  <div class="content-wrapper lb_template_categorypost_edit">
    <?php echo $__env->make('admin.partials.content-header',['name'=>"category post","key"=>"Edit"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
              ...
              <?php endif; ?>
              <form action="<?php echo e(route('admin.categorypost.postEdit',['id'=>$data->id])); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\webbanhang\resources\views/admin/page/categorypost/edit.blade.php ENDPATH**/ ?>