                    ...
                    <div class="box-bg">
                        ...
                        <div class="d-flex box-bg-content">
                            ...
                            <div class="button_tuvan">
                                <a href="<?php echo e(makeLinkToLanguage('bao-gia',null,null,App::getLocale())); ?>" class="btn-view"><i class="fa fa-paper-plane" aria-hidden="true"></i> <?php echo e($footer['nhan_tu_van']->name); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12 col-item-footer">
                                            <div class="footer-form">
                                                ...
                                                <form  action="<?php echo e(route('contact.storeAjax')); ?>"  data-url="<?php echo e(route('contact.storeAjax')); ?>" data-ajax="submit" data-target="alert" data-href="#modalAjax" data-content="#content" data-method="POST" method="POST" class="row p-75">
                                                    ...
                                                    <button type="submit" class="btn-form-submit"><?php echo e(__('footer.gui_yeu_cau_tu_van')); ?></button>
                                                </form>
...
<?php /**PATH D:\xampp\htdocs\php-laravel\web_tinh_toan\vision-2\backuptan\resources\views/frontend/partials/footer.blade.php ENDPATH**/ ?>