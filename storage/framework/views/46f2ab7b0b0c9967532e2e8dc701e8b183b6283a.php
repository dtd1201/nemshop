        ...
        if(idsArr.length <=0)  {  
            alert("Vui lòng chọn ít nhất một bản ghi để xóa.");  
                ...
                if(confirm("Bạn có chắc chắn không, bạn muốn xóa các bản ghi đã chọn ?")){  
                    ...
                    $.ajax({
                    url: "<?php echo e(route('admin.contact.multiple_contact_delete')); ?>",
                    type: 'POST',
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/demo.largevendor.com/httpdocs/resources/views/admin/pages/contact/index.blade.php ENDPATH**/ ?>