                            ...
                            <div class="fix-sidebar">
                                <div class="side-bar shadow">
                                    <div class="title-sider-bar">
                                        <span><?php echo e(__('tuyen-dung-detail.tin_tuc_noi_bat')); ?></span>
                                    </div>
                                ...
                                <div class="row p-75">
                                    <div class="col-xs-12  p-75">
                                        <div class="side-bar wrap-relate shadow">
                                            <div class="title-sider-bar">
                                                <span><?php echo e(__('tuyen-dung-detail.tin_tuc_lien_quan')); ?></span>
                                            </div>
                                            <div class="list-trending">
                                                <ul class="d-flex">
                                                    ...
                                                    <li class="col-sm-6 col-xs-12">
                                                        <div class="box">
                                                            <div class="icon">
                                                                <a href="<?php echo e(makeLink('tuyen-dung-detail',$item->id,$item->slug)); ?>"><img src="<?php echo e($item->avatar_path); ?>" alt="<?php echo e($item->name); ?>"></a>
                                                            </div>
                                                            <div class="content">
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php-laravel\web_tinh_toan\vision-2\backuptan\resources\views/frontend/pages/tuyendung-detail.blade.php ENDPATH**/ ?>