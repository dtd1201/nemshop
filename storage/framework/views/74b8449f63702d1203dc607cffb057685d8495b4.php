      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">           
              ...
              <?php endif; ?>
              <form action="<?php echo e(route('admin.category.product.postAdd')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                
                  <div class="form-group">
                  <label for="">Tên danh mục</label>
                  <input type="text" class="form-control" id="" value="<?php echo e(old('name')); ?>"  name="name" placeholder="Nhập tên danh mục">
...
unset($__errorArgs, $__bag); ?>
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control"  id="" value="<?php echo e(old('icon')); ?>" name="icon" >
                  </div>
...
unset($__errorArgs, $__bag); ?>
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control"  id="" value="<?php echo e(old('avatar')); ?>" name="avatar" >
                  </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\php-laravel\webbanhang\resources\views/admin/page/categoryproduct/add.blade.php ENDPATH**/ ?>